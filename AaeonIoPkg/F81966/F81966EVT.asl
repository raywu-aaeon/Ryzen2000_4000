...
//F81966_ERP_Miles--        Or(0x80, ^RGE0, ^RGE0)          //enable ERP function,bit7   
        And(0x7F, ^RGE0, ^RGE0)         //F81966_ERP_Miles++, disable ERP for S3/S4
        ^EXFG()
    }
}
...
//F81966_ERP_Miles--    And(0x7F, ^RGE0, ^RGE0)     //disable ERP function,bit7        
    ^EXFG()
}
