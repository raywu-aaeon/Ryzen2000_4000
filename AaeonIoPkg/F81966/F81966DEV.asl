...
//======================================================================
    ...
    IndexField(INDX, DATA, ByteAcc, NoLock, Preserve){
        ...
        DMCH, 8,        //DMA channel
        Offset(0x80),
        RG80, 8,        //Option Register 0x80
        RG81, 8,        //Option Register 0x81
        RG82, 8,        //Option Register 0x82
        RG83, 8,        //Option Register 0x83
        RG84, 8,        //Option Register 0x84
        RG85, 8,        //Option Register 0x85
        RG86, 8,        //Option Register 0x86
        RG87, 8,        //Option Register 0x87
        RG88, 8,        //Option Register 0x88
        RG89, 8,        //Option Register 0x89
        RG8A, 8,        //Option Register 0x8A
        RG8B, 8,        //Option Register 0x8B
        RG8C, 8,        //Option Register 0x8C
        RG8D, 8,        //Option Register 0x8D
        RG8E, 8,        //Option Register 0x8E
        RG8F, 8,        //Option Register 0x8F
        Offset(0x90),
        RG90, 8,        //Option Register 0x90
        RG91, 8,        //Option Register 0x91
        RG92, 8,        //Option Register 0x92
        RG93, 8,        //Option Register 0x93
        RG94, 8,        //Option Register 0x94
        RG95, 8,        //Option Register 0x95
        RG96, 8,        //Option Register 0x96
        RG97, 8,        //Option Register 0x97
        RG98, 8,        //Option Register 0x98
        RG99, 8,        //Option Register 0x99
        RG9A, 8,        //Option Register 0x9A
        RG9B, 8,        //Option Register 0x9B
        RG9C, 8,        //Option Register 0x9C
        RG9D, 8,        //Option Register 0x9D
        RG9E, 8,        //Option Register 0x9E
        RG9F, 8,        //Option Register 0x9F
        Offset(0xA0),
        RGA0, 8,        //Option Register 0xA0
        RGA1, 8,        //Option Register 0xA1
        RGA2, 8,        //Option Register 0xA2
        RGA3, 8,        //Option Register 0xA3
        RGA4, 8,        //Option Register 0xA4
        RGA5, 8,        //Option Register 0xA5
        RGA6, 8,        //Option Register 0xA6
        Offset(0xB0),
        RGB0, 8,        //Option Register 0xB0
        RGB1, 8,        //Option Register 0xB1
        RGB2, 8,        //Option Register 0xB2
        RGB3, 8,        //Option Register 0xB3
        Offset(0xC0),
        RGC0, 8,        //Option Register 0xC0
        RGC1, 8,        //Option Register 0xC1
        RGC2, 8,        //Option Register 0xC2
        RGC3, 8,        //Option Register 0xC3
        Offset(0xD0),
        RGD0, 8,        //Option Register 0xD0
        RGD1, 8,        //Option Register 0xD1
        RGD2, 8,        //Option Register 0xD2
        Offset(0xE0),
        RGE0, 8,        //Option Register 0xE0
        RGE1, 8,        //Option Register 0xE1
        RGE2, 8,        //Option Register 0xE2
        RGE3, 8,        //Option Register 0xE3
        RGE4, 8,        //Option Register 0xE4
        RGE5, 8,        //Option Register 0xE5
        RGE6, 8,        //Option Register 0xE6
        RGE7, 8,        //Option Register 0xE7
        RGE8, 8,        //Option Register 0xE8
        RGE9, 8,        //Option Register 0xE9
        Offset(0xF0),
...
//        RRIO(Arg0, Arg1, Local1, 0x08)
    ...
    Method(DCR3, 2) {
        ...
        //}
		 //FINETUNE_082_RayWu, ADD 2015/01/27 >>
		 If(And(OPT0,0x01)){
    ...
    Method(DSR3, 2) {
        ...
        If(IRQT){
            ...
            //Set IRQ sender(F81966) mode according to Arg0 (expecting it is resource description ACPI OS get from UART3~6.asl)
            //IRQ Receiver - ACPI IRQS: bit4:_SHR,bit3:_LL,bit0:_HE
            //IRQ Sender - Fintek IRQ_MODE1(OTP6[3]) and IRQ_MODE0(OPT0[1]):
            //    00 : Sharing IRQ active low Level mode.
            //    01 : Sharing IRQ active high edge mode.
