...
#if ((F81804_SMF1_SUPPORT == 1)||(F81804_SMF2_SUPPORT == 1))
  UINT8   i, temp;
#endif  
...
//---------------------------------------------------------------------------
//<AMI_PHDR_END>
void  F81804_SMF2_INIT(SETUP_DATA *SetupData)
{
	UINT8   i, temp;
    ...
    case 0:
    // Manual RPM Mode
      DXE_FAN2_INIT_TABLE[ IDX_FAN_MODE ].OrData8 = (0x02 << 4);//mode
      DXE_FAN2_INIT_TABLE[ IDX_FAN_TYPE ].OrData8 = (SetupData->FAN2OutputType << 4); //output type
    ...
    case 1:
      // Manual Duty Mode
      DXE_FAN2_INIT_TABLE[ IDX_FAN_MODE ].OrData8 = (0x03 << 4);//mode
      DXE_FAN2_INIT_TABLE[ IDX_FAN_TYPE ].OrData8 = (SetupData->FAN2OutputType << 4); //output type
    ...
    case 2:
      ...
      DXE_FAN2_INIT_TABLE[ IDX_FAN_TYPE ].OrData8 = (SetupData->FAN2OutputType << 4); //output type
      DXE_FAN2_INIT_TABLE[ IDX_TEMP_HYS ].OrData8 = 0x02; // Set hysteresis as 2
    ...
    case 3:
      // Auto Duty-Cycle Mode
      DXE_FAN2_INIT_TABLE[ IDX_FAN_MODE ].OrData8 = (0x01 << 4);//mode
      DXE_FAN2_INIT_TABLE[ IDX_FAN_TYPE ].OrData8 = (SetupData->FAN2OutputType << 4); //output type
      DXE_FAN2_INIT_TABLE[ IDX_TEMP_HYS ].OrData8 = 0x02; // Set hysteresis as 2      
