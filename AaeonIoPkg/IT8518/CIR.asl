...
// Name:  <CIR.asl>
//
// Description: Define ACPI device for CIR.
//
//<AMI_FHDR_END>
//*************************************************************************
// CIR //
...
//    Method(_SRS, 1) {^^SIO1.DSRS(Arg0, 0x10) }    //Set CIR recources
    Method(_STA, 0) {Return(^^EC01.DSTA(0x10))}    //Get CIR status
    Method(_DIS, 0) {^^EC01.DCNT(0x10, 0)}     //Disable CIR
    Method(_CRS, 0) {Return(^^EC01.DCRS(0x10, 0))}    //Get CIR current resources
    Method(_SRS, 1) {^^EC01.DSRS(Arg0, 0x10) }    //Set CIR recources
//RayWu, MODIFY 2014/03/26 <<
