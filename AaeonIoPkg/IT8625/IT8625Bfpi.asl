...
#endif
#ifndef ASL_IT8625_TMPIN1_STRING
    #define ASL_IT8625_TMPIN1_STRING "IT8625-TMPIN1"
#endif
#ifndef ASL_IT8625_TMPIN2_STRING
    #define ASL_IT8625_TMPIN2_STRING "IT8625-TMPIN2"
#endif
#ifndef ASL_IT8625_TMPIN3_STRING
    #define ASL_IT8625_TMPIN3_STRING "IT8625-TMPIN3"
#endif
#ifndef ASL_IT8625_TMPIN4_STRING
    #define ASL_IT8625_TMPIN4_STRING "IT8625-TMPIN4"
#endif
#ifndef ASL_IT8625_TMPIN5_STRING
    #define ASL_IT8625_TMPIN5_STRING "IT8625-TMPIN5"
#endif
#ifndef ASL_IT8625_TMPIN6_STRING
    #define ASL_IT8625_TMPIN6_STRING "IT8625-TMPIN6"
#endif
#ifndef ASL_IT8625_FAN_1_STRING
    #define ASL_IT8625_FAN_1_STRING "IT8625-FAN_1"
#endif
#ifndef ASL_IT8625_FAN_2_STRING
    #define ASL_IT8625_FAN_2_STRING "IT8625-FAN_2"
#endif
#ifndef ASL_IT8625_FAN_3_STRING
    #define ASL_IT8625_FAN_3_STRING "IT8625-FAN_3"
#endif
#ifndef ASL_IT8625_FAN_4_STRING
    #define ASL_IT8625_FAN_4_STRING "IT8625-FAN_4"
#endif
#ifndef ASL_IT8625_FAN_5_STRING
    #define ASL_IT8625_FAN_5_STRING "IT8625-FAN_5"
#endif
#ifndef ASL_IT8625_FAN_6_STRING
    #define ASL_IT8625_FAN_6_STRING "IT8625-FAN_6"
#endif
#ifndef ASL_IT8625_VIN0_STRING
    #define ASL_IT8625_VIN0_STRING "IT8625-VIN0"
#endif
#ifndef ASL_IT8625_VIN1_STRING
    #define ASL_IT8625_VIN1_STRING "IT8625-VIN1"
#endif
#ifndef ASL_IT8625_VIN2_STRING
    #define ASL_IT8625_VIN2_STRING "IT8625-VIN2"
#endif
#ifndef ASL_IT8625_VIN3_STRING
    #define ASL_IT8625_VIN3_STRING "IT8625-VIN3"
#endif
#ifndef ASL_IT8625_VIN4_STRING
    #define ASL_IT8625_VIN4_STRING "IT8625-VIN4"
#endif
#ifndef ASL_IT8625_VIN5_STRING
    #define ASL_IT8625_VIN5_STRING "IT8625-VIN5"
#endif
#ifndef ASL_IT8625_VIN6_STRING
    #define ASL_IT8625_VIN6_STRING "IT8625-VIN6"
#endif
#ifndef ASL_IT8625_3VSB_STRING
    #define ASL_IT8625_3VSB_STRING "IT8625-3VSB"
#endif
#ifndef ASL_IT8625_VBAT_STRING
    #define ASL_IT8625_VBAT_STRING "IT8625-VBAT"
#endif
#ifndef ASL_IT8625_AVCC3_STRING
    #define ASL_IT8625_AVCC3_STRING "IT8625-AVCC3"
#endif
#ifndef ASL_IT8625_TEMP_SENSOR_NUMBER
    #define ASL_IT8625_TEMP_SENSOR_NUMBER 0
#endif
#ifndef ASL_IT8625_FAN_SENSOR_NUMBER
    #define ASL_IT8625_FAN_SENSOR_NUMBER 0
#endif
#ifndef ASL_IT8625_VOLT_SENSOR_NUMBER
    #define ASL_IT8625_VOLT_SENSOR_NUMBER 0
#endif
...
IndexField(INDX, DATA, ByteAcc, NoLock, Preserve){
    ...
    Offset(0xD2),
    RGD2, 8,        //Simple I/O Set 9 Output Enable Register
    Offset(0xD4),
    RGD4, 8,        //GPIO Pin Set 9 Pin Internal Pull-up Enable Register
    Offset(0xD7),
    RGD7, 8,        //Simple I/O Set A Output Enable Register
    Offset(0xD9),
    RGD9, 8,        //GPIO Pin Set A Pin Internal Pull-up Enable Register
}        //End of indexed field

#if ASL_IT8625_GPIO_PORT_PRESENT
 //-----------------------------------------------------------------------
...
//---------------------------------------------------------------------------
    Method (D1GL, 1) {
        ...
        {
            ShiftRight(And(GP9X, Local3), Local2, Local4)       // GP9x Pin Status Register (Base Address + 8)
        } ElseIf (LEqual(Local1,10))
        {
            ShiftRight(And(GPAX, Local3), Local2, Local4)       // GPAx Pin Status Register (Base Address + 9)
        }
...
//---------------------------------------------------------------------------
    Method (D1SL, 2){
         ...
         {
             Or (And(GP9X,Not(Local3)), ShiftLeft(Arg1,Local2), GP9X)   // GP9x Pin Output Data Register (Base Address + 8)
         } ElseIf (LEqual(Local1,10))
         {
             Or (And(GPAX,Not(Local3)), ShiftLeft(Arg1,Local2), GPAX)   // GPAx Pin Output Data Register (Base Address + 9)
         }
...
//---------------------------------------------------------------------------
    Method (D1GD, 1) {
        ...
        ENFG(ASL_IT8625_LDN_GPIO)                                 //Enter Config Mode, Select GPIO LDN
        ...
        {
            ShiftRight(And(RGD2, Local3), Local2, Local4)           // GP9x Pin Output Enable Register Index D2h
        } ElseIf (LEqual(Local1,10))
        {
            ShiftRight(And(RGD7, Local3), Local2, Local4)           // GPAx Pin Output Enable Register Index D7h
        }
...
//---------------------------------------------------------------------------
    Method (D1SD, 2){
        ...
        {
            Or (And(RGD2,Not(Local3)), ShiftLeft(Arg1,Local2), RGD2)    // GP9x Pin Output Enable Register Index D2h
        } ElseIf (LEqual(Local1,10))
        {
            Or (And(RGD7,Not(Local3)), ShiftLeft(Arg1,Local2), RGD7)    // GPAx Pin Output Enable Register Index D7h
        }
...
//---------------------------------------------------------------------------
    Method (D1GO, 1) {
        ...
        {
            Return (ASL_BFPI_NOT_SUPPORTED)                         // GP2x Not Supported Internal Pull-up Enable
        } ElseIf (LEqual(Local1,3))
        {
        ...
        {
            If (LEqual(Local2,3) ) {
                Return (ASL_BFPI_NOT_SUPPORTED)                     // GP43 Not Supported Internal Pull-up Enable
            }
            ShiftRight(And(RGBB, Local3), Local2, Local4)           // GPIO Pin Set 4 Pin Internal Pull-up Enable Register
        } ElseIf (LEqual(Local1,5))
        {
            If(LOr(LEqual(Local2,3), LEqual(Local2, 4))) {
                Return (ASL_BFPI_NOT_SUPPORTED)                     // GP53 and GP54 Not Supported Internal Pull-up Enable
            }
            ShiftRight(And(RGBC, Local3), Local2, Local4)           // GPIO Pin Set 5 Pin Internal Pull-up Enable Register
        } ElseIf (LEqual(Local1,6))
        {
            If (LEqual(Local2,2) ) {
                Return (ASL_BFPI_NOT_SUPPORTED)                     // GP62 Not Supported Internal Pull-up Enable
            }
            ShiftRight(And(RGBD, Local3), Local2, Local4)           // GPIO Pin Set 6 Pin Internal Pull-up Enable Register
        } ElseIf (LEqual(Local1,7))
        {
            Return (ASL_BFPI_NOT_SUPPORTED)                         // GP7x Not Supported Internal Pull-up Enable
        } ElseIf (LEqual(Local1,8))
        {
            Return (ASL_BFPI_NOT_SUPPORTED)                         // GP8x Not Supported Internal Pull-up Enable
        } ElseIf (LEqual(Local1,9))
        {
            If (LEqual(Local2,0) ) {
                Return (ASL_BFPI_NOT_SUPPORTED)                     // GP90 Not Supported Internal Pull-up Enable
            }
            ShiftRight(And(RGD4, Local3), Local2, Local4)           // GPIO Pin Set 9 Pin Internal Pull-up Enable Register
        } ElseIf (LEqual(Local1,10))
        {
            If(LAnd(LGreater(Local1, 3), LLess(Local1, 7))) {
                Return (ASL_BFPI_NOT_SUPPORTED)                     // GPA4 ~ GPA6 Not Supported Internal Pull-up Enable
            }
            ShiftRight(And(RGD9, Local3), Local2, Local4)           // GPIO Pin Set A Pin Internal Pull-up Enable Register
        }
...
//---------------------------------------------------------------------------
    Method (D1SO, 2){
        ...
        } ElseIf (LEqual(Local1,9))
        {
            ...
            Or (And(RGD4,Not(Local3)), ShiftLeft(Arg1,Local2), RGD4)    // GPIO Pin Set 9 Pin Internal Pull-up Enable Register
        } ElseIf (LEqual(Local1,10))
        {
            If(LAnd(LGreater(Local1, 3), LLess(Local1, 7))) {
                Return (ASL_BFPI_NOT_SUPPORTED)                         // GPA4 ~ GPA6 Not Supported Internal Pull-up Enable
            }
            Or (And(RGD9,Not(Local3)), ShiftLeft(Arg1,Local2), RGD9)    // GPIO Pin Set A Pin Internal Pull-up Enable Register
        } 
...
#endif // ASL_IT8625_GPIO_PORT_PRESENT

#if ASL_IT8625_WDT_BFPI_SUPPORT
//---------------------------------------------------------------------------
// Name: W1RC
//
...
//---------------------------------------------------------------------------
    Method (W1GT, 0) {
        // IT8625 Watch Dog Timer Time-out Value registers
...
//---------------------------------------------------------------------------
    Method (W1ST, 1){
        ...
        //                                         -> 1 - Enable
        //
        // RG73 : Watch Dog Timer Time-out Value (MSB) + (LSB) Register
        //   [15-0] : WDT Time-out Value
...
#endif  //ASL_IT8625_WDT_BFPI_SUPPORT

#if  ASL_IT8625_HWM_PRESENT
//---------------------------------------------------------------------
//  Set of Field names to be used to access SIO configuration space.
//---------------------------------------------------------------------
...
//---------------------------------------------------------------------------
    Method (HCVV, 3){
        Multiply (Arg0, 109, Local0)  // reading unit is 10.9mV (*10 for excluding the float-point)
        Divide (Local0, 10, , Local0) // Revert for float point of the unit
        ...
        // Voltage = Reading * 10.9mV * (Ra + Rb) / Rb
...
//---------------------------------------------------------------------------
    Method (H1SN, 1){
        ...
        If (LEqual(Arg0, 0)) {
            // Temperature
            Store (ASL_IT8625_TEMP_SENSOR_NUMBER, Local0)
        } ElseIf (LEqual(Arg0, 1)) {
            // Fan
            Store (ASL_IT8625_FAN_SENSOR_NUMBER, Local0)
        } ElseIf (LEqual(Arg0, 2)) {
            // Voltage
            Store (ASL_IT8625_VOLT_SENSOR_NUMBER, Local0)
        }
        Return (Local0)
    }
...
//-------------------------------------------------------------------------
Name(THTS, Package() {
#if ASL_IT8625_TMPIN1_SUPPORT
    ASL_IT8625_TMPIN1_STRING,
#endif // IT8625_TMPIN1_SUPPORT
#if ASL_IT8625_TMPIN2_SUPPORT
    ASL_IT8625_TMPIN2_STRING,
#endif // IT8625_TMPIN2_SUPPORT
#if ASL_IT8625_TMPIN3_SUPPORT
    ASL_IT8625_TMPIN3_STRING,
#endif // IT8625_TMPIN3_SUPPORT
#if ASL_IT8625_TMPIN4_SUPPORT
    ASL_IT8625_TMPIN4_STRING,
#endif // IT8625_TMPIN4_SUPPORT
#if ASL_IT8625_TMPIN5_SUPPORT
    ASL_IT8625_TMPIN5_STRING,
#endif // IT8625_TMPIN5_SUPPORT
#if ASL_IT8625_TMPIN6_SUPPORT
    ASL_IT8625_TMPIN6_STRING,
...
Name(THFS, Package() {
#if ASL_FAN_TAC1
    ASL_IT8625_FAN_1_STRING,
#endif // FAN_TAC1
#if ASL_FAN_TAC2
    ASL_IT8625_FAN_2_STRING,
#endif // FAN_TAC2
#if ASL_FAN_TAC3
    ASL_IT8625_FAN_3_STRING,
#endif // FAN_TAC3
#if ASL_FAN_TAC4
    ASL_IT8625_FAN_4_STRING,
#endif // FAN_TAC4
#if ASL_FAN_TAC5
    ASL_IT8625_FAN_5_STRING,
#endif // FAN_TAC5
#if ASL_FAN_TAC6
    ASL_IT8625_FAN_6_STRING,
#endif // FAN_TAC6
})
...
//-------------------------------------------------------------------------
Name(THVS, Package() {
#if ASL_IT8625_VIN0_SUPPORT
    ASL_IT8625_VIN0_STRING,
#endif // IT8625_VIN0_SUPPORT
#if ASL_IT8625_VIN1_SUPPORT
    ASL_IT8625_VIN1_STRING,
#endif // IT8625_VIN1_SUPPORT
#if ASL_IT8625_VIN2_SUPPORT
    ASL_IT8625_VIN2_STRING,
#endif // IT8625_VIN2_SUPPORT
#if ASL_IT8625_VIN3_SUPPORT
    ASL_IT8625_VIN3_STRING,
#endif // IT8625_VIN3_SUPPORT
#if ASL_IT8625_VIN4_SUPPORT
    ASL_IT8625_VIN4_STRING,
#endif // IT8625_VIN4_SUPPORT
#if ASL_IT8625_VIN5_SUPPORT
    ASL_IT8625_VIN5_STRING,
#endif // IT8625_VIN5_SUPPORT
#if ASL_IT8625_VIN6_SUPPORT
    ASL_IT8625_VIN6_STRING,
#endif // IT8625_VIN6_SUPPORT
#if ASL_IT8625_3VSB_SUPPORT
    ASL_IT8625_3VSB_STRING,
#endif // IT8625_3VSB_SUPPORT
#if ASL_IT8625_VBAT_SUPPORT
    ASL_IT8625_VBAT_STRING,
#endif // IT8625_VBAT_SUPPORT
#if ASL_IT8625_AVCC3_SUPPORT
    ASL_IT8625_AVCC3_STRING,
...
// Name: ENBK
//
// Description:  IT8625 HWM Bank Selection (BANK_SEL)
//   Arg0 : Bank No.
//
// Output:
//   None
...
//---------------------------------------------------------------------------
    Method(ENBK, 1) {
        Store(HW06, local0)
        Or(And(local0, 0x9F), ShiftLeft(Arg0, 5), local1)
        Store(local1, HW06)
    }
...
//   Refer to IT8625ExternalFunList in IT8625HwmSetup.c.
//---------------------------------------------------------------------------
    Method (H1RS, 2){
        Store (ASL_BFPI_NOT_SUPPORTED, Local0)
        ENBK(0) // Select Bank 0
        If (LEqual(Arg0, 0)) {
          // Temperature
          #if ASL_IT8625_TMPIN1_SUPPORT
            If (LEqual(Arg1, ASL_IT8625_TMPIN1_STRING)) {  // TEMP1 - TMPIN1 Temperature
                Store (HW29, Local0)
          ...
          #endif // ASL_IT8625_TMPIN1_SUPPORT
          #if ASL_IT8625_TMPIN2_SUPPORT
            ElseIf (LEqual(Arg1, ASL_IT8625_TMPIN2_STRING)) {  // TEMP2 - TMPIN2 Temperature
                Store (HW2A, Local0)
                Store (HCVT (Local0, 0), Local0)
            }
          #endif // ASL_IT8625_TMPIN2_SUPPORT
          #if ASL_IT8625_TMPIN3_SUPPORT
            ElseIf (LEqual(Arg1, ASL_IT8625_TMPIN3_STRING)) {  // TEMP3 - TMPIN3 Temperature
                Store (HW2B, Local0)
                Store (HCVT (Local0, 0), Local0)
            }
          #endif // ASL_IT8625_TMPIN3_SUPPORT
          #if ASL_IT8625_TMPIN4_SUPPORT
            ElseIf (LEqual(Arg1, ASL_IT8625_TMPIN4_STRING)) {  // TEMP4 - TMPIN4 Temperature
                Store (HW2C, Local0)
                Store (HCVT (Local0, 0), Local0)
            }
          #endif // ASL_IT8625_TMPIN4_SUPPORT
          #if ASL_IT8625_TMPIN5_SUPPORT
            ElseIf (LEqual(Arg1, ASL_IT8625_TMPIN5_STRING)) {  // TEMP5 - TMPIN5 Temperature
                Store (HW2D, Local0)
                Store (HCVT (Local0, 0), Local0)
            }
          #endif // ASL_IT8625_TMPIN5_SUPPORT
          #if ASL_IT8625_TMPIN6_SUPPORT
            ElseIf (LEqual(Arg1, ASL_IT8625_TMPIN6_STRING)) {  // TEMP6 - TMPIN6 Temperature
                Store (HW2E, Local0)
                Store (HCVT (Local0, 0), Local0)
            }
          #endif // ASL_IT8625_TMPIN6_SUPPORT
        } ElseIf (LEqual(Arg0, 1)) {
          // Fan
          #if ASL_FAN_TAC1
            If (LEqual(Arg1, ASL_IT8625_FAN_1_STRING)) {               // FAN1
          ...
          #endif // ASL_FAN_TAC1
          #if ASL_FAN_TAC2
            ElseIf (LEqual(Arg1, ASL_IT8625_FAN_2_STRING)) {           // FAN2
          ...
          #endif // ASL_FAN_TAC2
          #if ASL_FAN_TAC3
            ElseIf (LEqual(Arg1, ASL_IT8625_FAN_3_STRING)) {           // FAN3
          ...
          #endif // ASL_FAN_TAC3
          #if ASL_FAN_TAC4
            ElseIf (LEqual(Arg1, ASL_IT8625_FAN_4_STRING)) {           // FAN4
          ...
          #endif // ASL_FAN_TAC4
          #if ASL_FAN_TAC5
            ElseIf (LEqual(Arg1, ASL_IT8625_FAN_5_STRING)) {           // FAN5
          ...
          #endif // ASL_FAN_TAC5
          #if ASL_FAN_TAC6
            ElseIf (LEqual(Arg1, ASL_IT8625_FAN_6_STRING)) {           // FAN6
                ShiftLeft(HW94, 8, Local0)                              // Get FAN6 count reading MSB
                Or(HW93, Local0, Local0)                                // Get FAN6 count reading LSB
                Store (1, Local1)                                       // Local1 : Default Divisor = 2
                Store (HCVF (Local0, Local1), Local0)
            }
          #endif // ASL_FAN_TAC6
          ...
          // Voltage
          #if ASL_IT8625_VIN0_SUPPORT
            If (LEqual(Arg1, ASL_IT8625_VIN0_STRING)) {           // VIN0
                Store (HW20, Local0)
          ...
          #endif // ASL_IT8625_VIN0_SUPPORT
          #if ASL_IT8625_VIN1_SUPPORT
            ElseIf (LEqual(Arg1, ASL_IT8625_VIN1_STRING)) {       // VIN1
                Store (HW21, Local0)
                Store( HCVV (Local0, ASL_VIN1_RA, ASL_VIN1_RB), Local0)
            }
          #endif // ASL_IT8625_VIN1_SUPPORT
          #if ASL_IT8625_VIN2_SUPPORT
            ElseIf (LEqual(Arg1, ASL_IT8625_VIN2_STRING)) {       // VIN2
                Store (HW22, Local0)
                Store( HCVV (Local0, ASL_VIN2_RA, ASL_VIN2_RB), Local0)
            }
          #endif // ASL_IT8625_VIN2_SUPPORT
          #if ASL_IT8625_VIN3_SUPPORT
            ElseIf (LEqual(Arg1, ASL_IT8625_VIN3_STRING)) {       // VIN3
                Store (HW23, Local0)
                Store( HCVV (Local0, ASL_VIN3_RA, ASL_VIN3_RB), Local0)
            }
          #endif // ASL_IT8625_VIN3_SUPPORT
          #if ASL_IT8625_VIN4_SUPPORT
            ElseIf (LEqual(Arg1, ASL_IT8625_VIN4_STRING)) {       // VIN4
                Store (HW24, Local0)
                Store( HCVV (Local0, ASL_VIN4_RA, ASL_VIN4_RB), Local0)
            }
          #endif // ASL_IT8625_VIN4_SUPPORT
          #if ASL_IT8625_VIN5_SUPPORT
            ElseIf (LEqual(Arg1, ASL_IT8625_VIN5_STRING)) {       // VIN5
                Store (HW25, Local0)
                Store( HCVV (Local0, ASL_VIN5_RA, ASL_VIN5_RB), Local0)
            }
          #endif // ASL_IT8625_VIN5_SUPPORT
          #if ASL_IT8625_VIN6_SUPPORT
            ElseIf (LEqual(Arg1, ASL_IT8625_VIN6_STRING)) {       // VIN6
                Store (HW26, Local0)
                Store( HCVV (Local0, ASL_VIN6_RA, ASL_VIN6_RB), Local0)
            }
          #endif // ASL_IT8625_VIN6_SUPPORT
          #if ASL_IT8625_3VSB_SUPPORT
            ElseIf (LEqual(Arg1, ASL_IT8625_3VSB_STRING)) {       // 3VSB
                Store (HW27, Local0)
                Store( HCVV (Local0, 0, 1), Local0)
                Multiply (Local0, 2, Local0)
            }
          #endif // ASL_IT8625_3VSB_SUPPORT
          #if ASL_IT8625_VBAT_SUPPORT
            ElseIf (LEqual(Arg1, ASL_IT8625_VBAT_STRING)) {       // VBAT
                Store (HW28, Local0)
                Store( HCVV (Local0, 0, 1), Local0)
                Multiply (Local0, 2, Local0)
            }
          #endif // ASL_IT8625_VBAT_SUPPORT
          #if ASL_IT8625_AVCC3_SUPPORT
            ElseIf (LEqual(Arg1, ASL_IT8625_AVCC3_STRING)) {       // AVCC3
                Store (HW2F, Local0)
                Store( HCVV (Local0, 0, 1), Local0)
                Multiply (Local0, 2, Local0)
            }
          #endif // ASL_IT8625_AVCC3_SUPPORT
        }
        Return (Local0)
    }
...
//-------------------------------------------------------------------------
Name(THFC, Package() {
#if ASL_IT8625_SMF1_SUPPORT
    ASL_IT8625_FAN_1_STRING,
#endif // IT8625_SMF1_SUPPORT
#if ASL_IT8625_SMF2_SUPPORT
    ASL_IT8625_FAN_2_STRING,
#endif // IT8625_SMF2_SUPPORT
#if ASL_IT8625_SMF3_SUPPORT
    ASL_IT8625_FAN_3_STRING,
#endif // IT8625_SMF3_SUPPORT
#if ASL_IT8625_SMF4_SUPPORT
    ASL_IT8625_FAN_4_STRING,
#endif // IT8625_SMF4_SUPPORT
#if ASL_IT8625_SMF5_SUPPORT
    ASL_IT8625_FAN_5_STRING,
#endif // IT8625_SMF5_SUPPORT
#if ASL_IT8625_SMF6_SUPPORT
    ASL_IT8625_FAN_6_STRING,
...
//---------------------------------------------------------------------------
    Method (F1TS, 1){
        ...
        #if ASL_IT8625_SMF1_SUPPORT
          If (LEqual(Arg0, ASL_IT8625_FAN_1_STRING)) {
              Store (DerefOf(Index(TSEL, ShiftRight(And(HW15,0x38), 3))), Local0)
          }
        #endif // IT8625_SMF1_SUPPORT
        #if ASL_IT8625_SMF2_SUPPORT
          If (LEqual(Arg0, ASL_IT8625_FAN_2_STRING)) {
              Store (DerefOf(Index(TSEL, ShiftRight(And(HW16,0x38), 3))), Local0)
          }
        #endif // IT8625_SMF2_SUPPORT
        #if ASL_IT8625_SMF3_SUPPORT
          If (LEqual(Arg0, ASL_IT8625_FAN_3_STRING)) {
              Store (DerefOf(Index(TSEL, ShiftRight(And(HW17,0x38), 3))), Local0)
          }
        #endif // IT8625_SMF3_SUPPORT
        #if ASL_IT8625_SMF4_SUPPORT
          If (LEqual(Arg0, ASL_IT8625_FAN_4_STRING)) {
              Store (DerefOf(Index(TSEL, ShiftRight(And(HW1E,0x38), 3))), Local0)
          }
        #endif // IT8625_SMF4_SUPPORT
        #if ASL_IT8625_SMF5_SUPPORT
          If (LEqual(Arg0, ASL_IT8625_FAN_5_STRING)) {
              Store (DerefOf(Index(TSEL, ShiftRight(And(HW1F,0x38), 3))), Local0)
          }
        #endif // IT8625_SMF5_SUPPORT
        #if ASL_IT8625_SMF6_SUPPORT
          If (LEqual(Arg0, ASL_IT8625_FAN_6_STRING)) {
              Store (DerefOf(Index(TSEL, ShiftRight(And(HW92,0x38), 3))), Local0)
          }
        #endif // IT8625_SMF6_SUPPORT
...
//---------------------------------------------------------------------------
    Method (F1PW, 1){
        #if ASL_IT8625_SMF1_SUPPORT
          If (LEqual(Arg0, ASL_IT8625_FAN_1_STRING)) {
            Return (ASL_IT8625_SMF_MAX_DUTY)
          }
        #endif // IT8625_SMF1_SUPPORT
        #if ASL_IT8625_SMF2_SUPPORT
          If (LEqual(Arg0, ASL_IT8625_FAN_2_STRING)) {
...
//---------------------------------------------------------------------------
    Method (F1RC, 1){
        ...
        #if ASL_IT8625_SMF1_SUPPORT
          If (LEqual(Arg0, ASL_IT8625_FAN_1_STRING)) {
            Store (ASL_IT8625_SMFC_FAN_1_PREFIX, Local0)
          }
        #endif // IT8625_SMF1_SUPPORT
        #if ASL_IT8625_SMF2_SUPPORT
          If (LEqual(Arg0, ASL_IT8625_FAN_2_STRING)) {
            Store (ASL_IT8625_SMFC_FAN_2_PREFIX, Local0)
          }
        #endif // IT8625_SMF2_SUPPORT
        #if ASL_IT8625_SMF3_SUPPORT
          If (LEqual(Arg0, ASL_IT8625_FAN_3_STRING)) {
            Store (ASL_IT8625_SMFC_FAN_3_PREFIX, Local0)
          }
        #endif // IT8625_SMF3_SUPPORT
        #if ASL_IT8625_SMF4_SUPPORT
          If (LEqual(Arg0, ASL_IT8625_FAN_4_STRING)) {
            Store (ASL_IT8625_SMFC_FAN_4_PREFIX, Local0)
          }
        #endif // IT8625_SMF4_SUPPORT
        #if ASL_IT8625_SMF5_SUPPORT
          If (LEqual(Arg0, ASL_IT8625_FAN_5_STRING)) {
            Store (ASL_IT8625_SMFC_FAN_5_PREFIX, Local0)
          }
        #endif // IT8625_SMF5_SUPPORT
        #if ASL_IT8625_SMF6_SUPPORT
          If (LEqual(Arg0, ASL_IT8625_FAN_6_STRING)) {
            Store (ASL_IT8625_SMFC_FAN_6_PREFIX, Local0)
          }
        #endif // IT8625_SMF6_SUPPORT

        Concatenate (Local0, Local1, Local0)
        Concatenate (Local0, ASL_IT8625_SMFC_FANOUT_SUFFIX, Local0)
        Return (Local0)
    }
...
//---------------------------------------------------------------------------
    Method (F1GM, 1){
        ...
        #if ASL_IT8625_SMF4_SUPPORT
          If (LEqual(Arg0, ASL_IT8625_FAN_4_STRING)) {
              And(HW1E, 0x80, Local1)                     // Index 1Eh Bit[7]: FAN_CTL4 PWM Mode
              If (LEqual(Local1, 0x80)) {                 // Bit[7] = 1b : Automatic operation
                  Store (2, Local0)
              }
              Else {                                      // Bit[7] = 0b : Software operation
                  Store (0, Local0)
                  Or (Local0, ShiftLeft(HW7B, 8), Local0) // Index 7Bh: FAN_CTL4 duty value
              }
          }
        #endif // IT8625_SMF4_SUPPORT
        #if ASL_IT8625_SMF5_SUPPORT
          If (LEqual(Arg0, ASL_IT8625_FAN_5_STRING)) {
              And(HW1F, 0x80, Local1)                     // Index 1Fh Bit[7]: FAN_CTL5 PWM Mode
              If (LEqual(Local1, 0x80)) {                 // Bit[7] = 1b : Automatic operation
                  Store (2, Local0)
              }
              Else {                                      // Bit[7] = 0b : Software operation
                  Store (0, Local0)
                  Or (Local0, ShiftLeft(HWA3, 8), Local0) // Index A3h: FAN_CTL5 duty value
              }
          }
        #endif // IT8625_SMF5_SUPPORT
        #if ASL_IT8625_SMF6_SUPPORT
          If (LEqual(Arg0, ASL_IT8625_FAN_6_STRING)) {
              And(HW92, 0x80, Local1)                     // Index 92h Bit[7]: FAN_CTL6 PWM Mode
              If (LEqual(Local1, 0x80)) {                 // Bit[7] = 1b : Automatic operation
                  Store (2, Local0)
              }
              Else {                                      // Bit[7] = 0b : Software operation
                  Store (0, Local0)
                  Or (Local0, ShiftLeft(HWAB, 8), Local0) // Index ABh: FAN_CTL6 duty value
              }
          }
        #endif // IT8625_SMF6_SUPPORT
...
//---------------------------------------------------------------------------
    Method (F1SM, 3){
        If (LAnd(LEqual(Arg1, 0), LGreater(Arg2, ASL_IT8625_SMF_MAX_DUTY))) {
            Return (ASL_BFPI_INVALID_PARAMETER)
        }
        ...
        #if ASL_IT8625_SMF4_SUPPORT
          If (LEqual(Arg0, ASL_IT8625_FAN_4_STRING)) {
              And(HW1E, 0x7F, Local1)     // Index 1E Bit[7]: FAN_CTL4 PWM Mode
              If (LEqual(Arg1, 0)) {      // If Manual Mode
                  Store(Arg2, HW7B)       // Index 7B Bit[7:0] : FAN_CTL4 PWM value
                  Store(Local1, HW1E)     // Index 1E Bit[7] = 0b : Software operation
              }
              Else {
                  Or(Local1, 0x80, HW1E)  // Index 1E Bit[7] = 1b : Automatic operation
              }
              Store (ASL_BFPI_SUCCESS, Local0)
          }
        #endif // IT8625_SMF4_SUPPORT
        #if ASL_IT8625_SMF5_SUPPORT
          If (LEqual(Arg0, ASL_IT8625_FAN_5_STRING)) {
              And(HW1F, 0x7F, Local1)     // Index 1F Bit[7]: FAN_CTL5 PWM Mode
              If (LEqual(Arg1, 0)) {      // If Manual Mode
                  Store(Arg2, HWA3)       // Index A3 Bit[7:0] : FAN_CTL5 PWM value
                  Store(Local1, HW1F)     // Index 1F Bit[7] = 0b : Software operation
              }
              Else {
                  Or(Local1, 0x80, HW1F)  // Index 1F Bit[7] = 1b : Automatic operation
              }
              Store (ASL_BFPI_SUCCESS, Local0)
          }
        #endif // IT8625_SMF5_SUPPORT
        #if ASL_IT8625_SMF6_SUPPORT
          If (LEqual(Arg0, ASL_IT8625_FAN_6_STRING)) {
              And(HW92, 0x7F, Local1)     // Index 92 Bit[7]: FAN_CTL6 PWM Mode
              If (LEqual(Arg1, 0)) {      // If Manual Mode
                  Store(Arg2, HWAB)       // Index AB Bit[7:0] : FAN_CTL6 PWM value
                  Store(Local1, HW92)     // Index 92 Bit[7] = 0b : Software operation
              }
              Else {
                  Or(Local1, 0x80, HW92)  // Index 92 Bit[7] = 1b : Automatic operation
              }
              Store (ASL_BFPI_SUCCESS, Local0)
          }
        #endif // IT8625_SMF6_SUPPORT
    ...
    Method (F1GP, 2){
        ...
        ENBK(0) // Select Bank 0
          ...
          If (LEqual(Arg0, ASL_IT8625_FAN_4_STRING)) {
              ...
              {
                  case (0x0) { // lowest point
                    Store (HW7B, Local0) // Report Start PWM as lowest duty cycle
                    Or (Local0, ShiftLeft(HW79, 8), Local0) // Report Start Control Temperature as lowest temperature
                  }
                  case (0x2) { // Slope
                    Store (ShiftLeft(And(HW7C, 0x7F), 5), Local0)  // Get PWM Slope
                  }
              }
          }
        #endif // IT8625_SMF4_SUPPORT
          ...
          If (LEqual(Arg0, ASL_IT8625_FAN_5_STRING)) {
              ...
              {
                  case (0x0) { // lowest point
                    Store (HWA3, Local0) // Report Start PWM as lowest duty cycle
                    Or (Local0, ShiftLeft(HWA1, 8), Local0) // Report Start Control Temperature as lowest temperature
                  }
                  case (0x2) { // Slope
                    Store (ShiftLeft(And(HWA4, 0x7F), 5), Local0)  // Get PWM Slope
                  }
              }
          }
        #endif // IT8625_SMF5_SUPPORT
          ...
          If (LEqual(Arg0, ASL_IT8625_FAN_6_STRING)) {
              ...
              {
                  case (0x0) { // lowest point
                    Store (HWAB, Local0) // Report Start PWM as lowest duty cycle
                    Or (Local0, ShiftLeft(HWA9, 8), Local0) // Report Start Control Temperature as lowest temperature
                  }
                  case (0x2) { // Slope
                    Store (ShiftLeft(And(HWAC, 0x7F), 5), Local0)  // Get PWM Slope
                  }
              }
          }
        #endif // IT8625_SMF6_SUPPORT
...
//---------------------------------------------------------------------------
    Method (F1SP, 4){
        switch (Arg1) { // Validate input first
          case (0x0) {  // Set lowest point
              If (LGreater(Arg2, ASL_IT8625_SMF_MAX_DUTY)) { Return (ASL_BFPI_INVALID_PARAMETER) }
          }
          case (0x2) {  // Set Slope
              And(HW64, 0x80, Local1)
              If (LGreater(Arg2, 0xFF)) { Return (ASL_BFPI_INVALID_PARAMETER) }
              If (LGreater(Arg3, 0x0F)) { Return (ASL_BFPI_INVALID_PARAMETER) } // Max slope is 15
          }
          Default { return (ASL_BFPI_NOT_SUPPORTED) }
        }
        Store (ASL_BFPI_NOT_SUPPORTED, Local0)
        ENBK(0) // Select Bank 0
          ...
          If (LEqual(Arg0, ASL_IT8625_FAN_1_STRING)) {
              ...
              Subtract(ASL_IT8625_SMF_MAX_DUTY, HW63, Local2)  // Local2 : PWM Delta
          ...
          If (LEqual(Arg0, ASL_IT8625_FAN_2_STRING)) {
              ...
              Subtract(ASL_IT8625_SMF_MAX_DUTY, HW6B, Local2)  // Local2 : PWM Delta
              Divide (Local2, Local1, Local4, Local3)  // Local3 : The temperature delta of the lowest and maximum PWM
                                                       // Local4 : Remainder
              Divide (Multiply(Local4, 2), Local1,, Local2)
              If (LGreater(Local2, 0)) {
          ...
          If (LEqual(Arg0, ASL_IT8625_FAN_3_STRING)) {
              ...
              Subtract(ASL_IT8625_SMF_MAX_DUTY, HW73, Local2)  // Local2 : PWM Delta
              Divide (Local2, Local1, Local4, Local3)  // Local3 : The temperature delta of the lowest and maximum PWM
                                                       // Local4 : Remainder
              Divide (Multiply(Local4, 2), Local1,, Local2)
              If (LGreater(Local2, 0)) {
          ...
          If (LEqual(Arg0, ASL_IT8625_FAN_4_STRING)) {
              ...
              switch (Arg1) {
                case (0x0) {  // Set lowest point
                    Store (Arg2, HW7B)  // Set the Start PWM register as the lowest duty
                    Store (Arg3, HW79)  // Set the Start Temperature register as the lowest temperature
                    If (LLess(HW79, HW78)) {  // If the lowest temperature < Off Control Temperature
                        Store (HW79, HW78)  // To sync the Off Control Temperature same as the lowest temperature
                    }
                }
                case (0x2) {  // Set Slope
                    And(HW7C, 0x80, Local1)
                    Or (Local1, ShiftLeft(Arg3, 3), Local1)  // Set PMW Slope (Integer)
                    Or (Local1, ShiftRight(Arg2, 5), Local1)  // Set PMW Slope (Digit)
                    Store (Local1, HW7C)  // Set Slope to register
                }
                Default { return (ASL_BFPI_NOT_SUPPORTED) }
              }
              ShiftRight(And(HW7C, 0x78), 3, Local1) // Get Slope (Integer)
              Subtract(ASL_IT8625_SMF_MAX_DUTY, HW7B, Local2)  // Local2 : PWM Delta
              Divide (Local2, Local1, Local4, Local3)  // Local3 : The temperature delta of the lowest and maximum PWM
                                                       // Local4 : Remainder
              Divide (Multiply(Local4, 2), Local1,, Local2)
              If (LGreater(Local2, 0)) {
              ...
              Add(HW79, Local3, Local2)  // Local2 = The calculated Highest Temperature (PWM ≒ 255)
              If (LGreater(Local2, 0x7F)) {  // If the calculated Highest Temperature > 127°C
                  Store (0x7F, Local2)  // Replace the calculated Highest Temperature as the maximum supported temperature
              }
              If (LGreater(Local2, HW7A)) { // If the calculated Highest Temperature > Full Speed Temperature
                  Store (Local2, HW7A)  // Set Full Speed Temperature = Highest Temperature
              }
          }
        #endif // IT8625_SMF4_SUPPORT
        #if ASL_IT8625_SMF5_SUPPORT
          If (LEqual(Arg0, ASL_IT8625_FAN_5_STRING)) {
              ...
              switch (Arg1) {
                case (0x0) {  // Set lowest point
                    Store (Arg2, HWA3)  // Set the Start PWM register as the lowest duty
                    Store (Arg3, HWA1)  // Set the Start Temperature register as the lowest temperature
                    If (LLess(HWA1, HWA0)) {  // If the lowest temperature < Off Control Temperature
                        Store (HWA1, HWA0)  // To sync the Off Control Temperature same as the lowest temperature
                    }
                }
                case (0x2) {  // Set Slope
                    And(HWA4, 0x80, Local1)
                    Or (Local1, ShiftLeft(Arg3, 3), Local1)  // Set PMW Slope (Integer)
                    Or (Local1, ShiftRight(Arg2, 5), Local1)  // Set PMW Slope (Digit)
                    Store (Local1, HWA4)  // Set Slope to register
                }
                Default { return (ASL_BFPI_NOT_SUPPORTED) }
              }
              ShiftRight(And(HWA4, 0x78), 3, Local1) // Get Slope (Integer)
              Subtract(ASL_IT8625_SMF_MAX_DUTY, HWA3, Local2)  // Local2 : PWM Delta
              Divide (Local2, Local1, Local4, Local3)  // Local3 : The temperature delta of the lowest and maximum PWM
                                                       // Local4 : Remainder
              Divide (Multiply(Local4, 2), Local1,, Local2)
              If (LGreater(Local2, 0)) {
              ...
              Add(HWA1, Local3, Local2)  // Local2 = The calculated Highest Temperature (PWM ≒ 255)
              If (LGreater(Local2, 0x7F)) {  // If the calculated Highest Temperature > 127°C
                  Store (0x7F, Local2)  // Replace the calculated Highest Temperature as the maximum supported temperature
              }
              If (LGreater(Local2, HWA2)) { // If the calculated Highest Temperature > Full Speed Temperature
                  Store (Local2, HWA2)  // Set Full Speed Temperature = Highest Temperature
              }
          }
        #endif // IT8625_SMF5_SUPPORT
        #if ASL_IT8625_SMF6_SUPPORT
          If (LEqual(Arg0, ASL_IT8625_FAN_6_STRING)) {
              ...
              switch (Arg1) {
                case (0x0) {  // Set lowest point
                    Store (Arg2, HWAB)  // Set the Start PWM register as the lowest duty
                    Store (Arg3, HWA9)  // Set the Start Temperature register as the lowest temperature
                    If (LLess(HWA9, HWA8)) {  // If the lowest temperature < Off Control Temperature
                        Store (HWA9, HWA8)  // To sync the Off Control Temperature same as the lowest temperature
                    }
                }
                case (0x2) {  // Set Slope
                    And(HWAC, 0x80, Local1)
                    Or (Local1, ShiftLeft(Arg3, 3), Local1)  // Set PMW Slope (Integer)
                    Or (Local1, ShiftRight(Arg2, 5), Local1)  // Set PMW Slope (Digit)
                    Store (Local1, HWAC)  // Set Slope to register
                }
                Default { return (ASL_BFPI_NOT_SUPPORTED) }
              }
              ShiftRight(And(HWAC, 0x78), 3, Local1) // Get Slope (Integer)
              Subtract(ASL_IT8625_SMF_MAX_DUTY, HWAB, Local2)  // Local2 : PWM Delta
              Divide (Local2, Local1, Local4, Local3)  // Local3 : The temperature delta of the lowest and maximum PWM
                                                       // Local4 : Remainder
              Divide (Multiply(Local4, 2), Local1,, Local2)
              If (LGreater(Local2, 0)) {
              ...
              Add(HWA9, Local3, Local2)  // Local2 = The calculated Highest Temperature (PWM ≒ 255)
              If (LGreater(Local2, 0x7F)) {  // If the calculated Highest Temperature > 127°C
                  Store (0x7F, Local2)  // Replace the calculated Highest Temperature as the maximum supported temperature
              }
              If (LGreater(Local2, HWAA)) { // If the calculated Highest Temperature > Full Speed Temperature
                  Store (Local2, HWAA)  // Set Full Speed Temperature = Highest Temperature
              }
          }
        #endif // IT8625_SMF6_SUPPORT
