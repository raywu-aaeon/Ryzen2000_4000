...
BOOLEAN SkipCertificationValidation (IN HTTP_PROTOCOL      *HttpInstance)
{
  ...
  SkipCertificate= LibPcdGetEx8 (&gEfiNetworkPkgTokenSpaceGuid, PcdToken(PcdSkipHttpsCertValidation));
...
#if (NET_PKG_AMI_PORTING_ENABLE == 1)  
if ((FALSE == SkipCertificationValidation (HttpInstance)) && (FALSE == LibPcdGetEx8 (&gEfiNetworkPkgTokenSpaceGuid, PcdToken(PcdSkipHostNameValidation)))) {
