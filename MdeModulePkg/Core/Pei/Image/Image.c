...
//*** AMI PORTING BEGIN ***//
  // Status was being used in the DEBUG code that was added. There are use cases where it is not intialized at that point.
  // Initialized it to an error state to cover this case
