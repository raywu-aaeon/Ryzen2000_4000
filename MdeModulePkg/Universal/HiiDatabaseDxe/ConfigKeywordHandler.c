...
BOOLEAN
//*** AMI PORTING BEGIN ***//
//Changing function to detect Questions, not Statements
//IsStatementOpCode  (
IsQuestionOpCode (
//*** AMI PORTING END ***//        
  IN UINT8              Operand
...
//    if (IsStatementOpCode(OpCodeHeader->OpCode)) {
    if (IsQuestionOpCode(OpCodeHeader->OpCode)) {
//*** AMI PORTING END ***//
...
//*** AMI PORTING BEGIN ***//
      if (Header->VarStoreId == 0) return EFI_NOT_FOUND;
//*** AMI PORTING END ***//
