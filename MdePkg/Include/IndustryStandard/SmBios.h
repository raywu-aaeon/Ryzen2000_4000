...
//**************** AMI PORTING BEGIN  *****************************
  ...
  // Added for 3.4 Spec
  ProcessorUpgradeSocketLGA4189   = 0x3D,   // Socket LGA4189
  ProcessorUpgradeSocketLGA1200   = 0x3E    // Socket LGA1200
//**************** AMI PORTING END  *****************************
} PROCESSOR_UPGRADE;
...
typedef enum {
  ...
  SlotTypePciExpressGen4Sff_8639       = 0x24,      /// Added PCI Express Gen 4 U.2 values for smbios 3.4.0 spec
  SlotTypePciExpressGen5Sff_8639       = 0x25,      /// Added PCI Express Gen 5 U.2 values for smbios 3.4.0 spec  
  SlotTypePciExpressOCPNIC30SFF        = 0x26,      /// OCP NIC 3.0 Small Form Factor.
  SlotTypePciExpressOCPNIC30LFF        = 0x27,      /// OCP NIC 3.0 Large Form Factor.
  SlotTypePciExpressOCPNICPriorTo30    = 0x28,      /// OCP NIC Prior to 3.0
//**************** AMI PORTING END  *****************************
...
//**************** AMI PORTING BEGIN  *****************************
  ...
  // Added for Smbios 3.4.0 Spec
  SlotTypePciExpressGen5               = 0xBE, // PCI Express Gen 5
  SlotTypePciExpressGen5X1             = 0xBF, // PCI Express Gen 5 x1
  SlotTypePciExpressGen5X2             = 0xC0, // PCI Express Gen 5 x2
  SlotTypePciExpressGen5X4             = 0xC1, // PCI Express Gen 5 x4
  SlotTypePciExpressGen5X8             = 0xC2, // PCI Express Gen 5 x8
  SlotTypePciExpressGen5X16            = 0xC3, // PCI Express Gen 5 x16
  SlotTypePciExpressGen6               = 0xC4, // PCI Express Gen 6
  SlotTypePciExpressEDSFF              = 0xC5, // EDSFF
  SlotTypePciExpressEDSFF3             = 0xC6  // EDSFF3
//**************** AMI PORTING END  *****************************
...
//**************** AMI PORTING BEGIN  *****************************
  // Changes made for smbios spec 3.4.0
  UINT8  AsyncSurpriseSlotSupported :1; // Slot supports async/surprise removal
  UINT8  FlexbusslotCXL1X0         :1; // Flexbus slot, CXL 1.0
  UINT8  FlexbusslotCXL2X0         :1; // Flexbus slot, CXL 2.0 
