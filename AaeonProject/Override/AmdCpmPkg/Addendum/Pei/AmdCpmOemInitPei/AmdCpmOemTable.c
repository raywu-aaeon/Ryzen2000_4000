...
//         (socket,die,gpio,function,        output,           pullup)
    GPIO_DEFINITION (3,   GPIO_FUNCTION_0,  GPIO_INPUT,       GPIO_PU_EN,     GPIO_STICKY_DIS),   // KR10G_XCVR_INTR0#
    GPIO_DEFINITION (4,   GPIO_FUNCTION_0,  GPIO_INPUT,       GPIO_PU_EN,     GPIO_STICKY_DIS),   // KR10G_XCVR_INTR1#
    ...
    GPIO_DEFINITION (7,   GPIO_FUNCTION_1,  GPIO_NA,          GPIO_PD_EN,     GPIO_STICKY_DIS),   // AGPIO7/FCH_ACP_I2S_SDIN  // Set to FCH_ACP_I2S_SDIN
    GPIO_DEFINITION (8,   GPIO_FUNCTION_1,  GPIO_NA,          GPIO_PD_EN,     GPIO_STICKY_DIS),   // AGPIO8/FCH_ACP_I2S_LRCLK // Set to FCH_ACP_I2S_LRCLK
    ...
    GPIO_DEFINITION (11,  GPIO_FUNCTION_1,  GPIO_OUTPUT_HIGH, GPIO_PU_EN,     GPIO_STICKY_DIS),   // BLINK
    GPIO_DEFINITION (12,  GPIO_FUNCTION_1,  GPIO_OUTPUT_LOW,  GPIO_PU_PD_DIS, GPIO_STICKY_DIS),   // AGPIO12 (VDDP_SET, 0 => 0.9, 1 => 0.8).
    GPIO_DEFINITION (13,  GPIO_FUNCTION_0,  GPIO_NA,          GPIO_PU_EN,     GPIO_STICKY_DIS),   // USB_OC5#
    GPIO_DEFINITION (14,  GPIO_FUNCTION_0,  GPIO_NA,          GPIO_PU_EN,     GPIO_STICKY_DIS),   // USB_OC4#
    GPIO_DEFINITION (16,  GPIO_FUNCTION_0,  GPIO_NA,          GPIO_PU_EN,     GPIO_STICKY_DIS),   // USB_OC0#
    GPIO_DEFINITION (17,  GPIO_FUNCTION_0,  GPIO_NA,          GPIO_PU_EN,     GPIO_STICKY_DIS),   // USB_OC1#
    GPIO_DEFINITION (18,  GPIO_FUNCTION_0,  GPIO_NA,          GPIO_PU_EN,     GPIO_STICKY_DIS),   // USB_OC2#
    GPIO_DEFINITION (23,  GPIO_FUNCTION_2,  GPIO_NA, 		  GPIO_PU_EN,     GPIO_STICKY_DIS),   // MDIO_SDAT1
    GPIO_DEFINITION (24,  GPIO_FUNCTION_0,  GPIO_NA,          GPIO_PU_EN,     GPIO_STICKY_DIS),   // USB_OC3#
    ...
    GPIO_DEFINITION (40,  GPIO_FUNCTION_2,  GPIO_NA,          GPIO_PU_EN,     GPIO_STICKY_DIS),   // MDIO_SDAT0 (SFP+_SDAT or PHY0_MDIO_DATA)
    GPIO_DEFINITION (41,  GPIO_FUNCTION_0,  GPIO_NA,          GPIO_PU_EN,     GPIO_STICKY_DIS),   // EGPIO41
    GPIO_DEFINITION (42,  GPIO_FUNCTION_0,  GPIO_OUTPUT_HIGH, GPIO_PU_EN,     GPIO_STICKY_DIS),   // GPP_10G_SELECT => High=10G, Low=x2  NVME ( work with AGPIO89)
    GPIO_DEFINITION (67,  GPIO_FUNCTION_1,  GPIO_OUTPUT_LOW,  GPIO_PD_EN,     GPIO_STICKY_DIS),   // APU_SSD_HDD_SW1
    GPIO_DEFINITION (68,  GPIO_FUNCTION_1,  GPIO_INPUT,       GPIO_PU_EN,     GPIO_STICKY_DIS),   // AGPIO68 //EMMC_CD  //SD_CD_SGPIO_CLK
    GPIO_DEFINITION (69,  GPIO_FUNCTION_0,  GPIO_INPUT,       GPIO_PD_EN,     GPIO_STICKY_DIS),   // PCI_X4_PRSNT#
    GPIO_DEFINITION (76,  GPIO_FUNCTION_1,  GPIO_NA,          GPIO_PD_EN,     GPIO_STICKY_DIS),   // AGPIO76
    GPIO_DEFINITION (84,  GPIO_FUNCTION_0,  GPIO_INPUT,       GPIO_PU_EN,     GPIO_STICKY_DIS),   // FANTACH0
    GPIO_DEFINITION (85,  GPIO_FUNCTION_0,  GPIO_OUTPUT_HIGH, GPIO_PU_EN,     GPIO_STICKY_DIS),   // FANOUT0
    GPIO_DEFINITION (86,  GPIO_FUNCTION_1,  GPIO_OUTPUT_HIGH, GPIO_PU_EN,     GPIO_STICKY_DIS),   // AGPIO86 => High for LPC and Low for eMMC & SD (Need reworks for SD)
    GPIO_DEFINITION (89,  GPIO_FUNCTION_2,  GPIO_OUTPUT_HIGH, GPIO_PU_EN,     GPIO_STICKY_DIS),   // APU_COMBO_GPP_SW => High=SATA, Low=x2  NVME (work with EGPIO42)
    GPIO_DEFINITION (90,  GPIO_FUNCTION_2,  GPIO_OUTPUT_HIGH, GPIO_PU_EN,     GPIO_STICKY_DIS),   // AGPIO90 => High, UART1 in 4-wire mode; LOW, UART1 in two-wire mode
    GPIO_DEFINITION (91,  GPIO_FUNCTION_0,  GPIO_OUTPUT_HIGH, GPIO_PD_EN,     GPIO_STICKY_DIS),   // PC_BEEP
    GPIO_DEFINITION (92,  GPIO_FUNCTION_3,  GPIO_INPUT,       GPIO_PU_EN,     GPIO_STICKY_DIS),   // SSD_PEDET
