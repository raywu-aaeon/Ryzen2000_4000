...
//*****************************************************************//
//*****************************************************************//
// $Header: /AptioV/SRC/Debugger/Include/Library/dbgr.h 11    9/25/15 5:22p Sudhirv $
//
// $Revision: 11 $
//
// $Date: 9/25/15 5:22p $
...
// Revision History
// ----------------
// $Log: /AptioV/SRC/Debugger/Include/Library/dbgr.h $
// 
// 11    9/25/15 5:22p Sudhirv
// [TAG]			EIP224984
// [Category]   	New Feature
// [Severity]		Minor
// [Description]	Add support to Display SMM Outside Context in
// AptioVDebugger
// [Files]			Dbgr.c
// dbgcmd.h
// dbgr.h
// 
// 10    9/23/15 1:11p Manishs
// EIP:220837
// Synopsis:[Debugger] NVRAM reading support in Debugger Core -
// Implementation
// 
// 9     9/16/15 2:37a Krutikkumaram
// [TAG]	EIP233498
// [Category]	New Feature
// [Description]	 Debugger Scripting Support - Target commands
// implementation
// [Files]	dbgr.h
// 
// 8     6/09/15 6:39a Jekekumarg
// [TAG]			EIP219359
// [Category]   	Bug Fix
// [Severity]		Normal
// [Symptom]  	Reading Memory contents from NVRAM Base address before
// Memory Init is giving wrong data
// [RootCause]	before memory init when we were trying to read the
//  NVRAM_ADDRESS then Target was not checking 
// whether the (NVRAM_ADDRESS + 256) was falling 
// under FLASH range or not.its only checking whether 
// NVRAM_ADDRESS was falling within flash range 
// or not and accordingly it was clearing the memory 
// and was sending to HOST.
// [Solution]		modified code to check whether both NVRAM_ADDRESS
//  and (NVRAM_ADDRESS + 256) is coming within 
// FLASH range or not.
// [Files]			Dbgr.c
// dbgr.h
// 
// 7     12/22/14 1:37a Sudhirv
// [TAG]	EIP196769
// [Category]	Bug Fix
// [Symptom:]	 Local variables can display in DXE but PEI phase still
// fail, global variable still cannot display on both phases
// [Files]	dbgr.h
// 
// 5     12/03/14 11:47a Sudhirv
// [TAG]	EIP186481
// [Category]	Bug Fix
// [Symptom:]	Halt on SMM entry and exit are not working
// [Files]	dbgcmd.h
// dbgr.h
// IncludeLib.cif
// 
// 4     2/20/14 5:02p Sudhirv
