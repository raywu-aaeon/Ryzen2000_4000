...
//static EFI_TIME  gEfiTime = {0,0,0,0};
static EFI_TIME gEfiTime = {
   FOUR_DIGIT_YEAR_INT,
   TWO_DIGIT_MONTH_INT,
   TWO_DIGIT_DAY_INT,
   TWO_DIGIT_HOUR_INT,
...
//static EFI_TIME *crEfiTime = &gEfiTime;
/**
...
//    memcpy((void*)crEfiTime,(void*)EfiTime, sizeof(EFI_TIME));
    memcpy((void*)&gEfiTime,(void*)EfiTime, sizeof(EFI_TIME));
...
//           crEfiTime->Year, crEfiTime->Month, crEfiTime->Day, crEfiTime->Hour, crEfiTime->Minute, crEfiTime->Second);
           gEfiTime.Year, gEfiTime.Month, gEfiTime.Day, gEfiTime.Hour, gEfiTime.Minute, gEfiTime.Second);
}
...
int os_get_time(struct os_time *t)
{
    ...
    err = os_mktime(gEfiTime.Year, gEfiTime.Month, gEfiTime.Day, gEfiTime.Hour, gEfiTime.Minute, gEfiTime.Second, &Tm);
