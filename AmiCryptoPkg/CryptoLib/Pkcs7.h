...
// authAttributes
    ...
    // contentType
    struct x509_algorithm_identifier ContentInfo;
    // messageDigest
...
// SignerInfo encryptedDigest info
struct pkcs7_signer_info_enc_digest_info_st {
    struct x509_algorithm_identifier enc_digest_alg;
// optional RSASSA-PSS ptr to ASN1 data structure within p7 DER cert
    struct x509_algorithm_identifier digest_alg;
//  struct x509_algorithm_identifier maskGenAlgorithm;
    size_t    saltlen;
//    size_t    trailerField;
};
...
//encryptedDigest
    struct pkcs7_signer_info_enc_digest_info_st enc_digest_info;
// obsolete
//    struct x509_algorithm_identifier enc_digest_alg;
    const u8 *enc_digest;
...
int Pkcs7_parse_digestAlgorithm(struct asn1_oid *oid, 
        u8* HashType, size_t *HashLen);
