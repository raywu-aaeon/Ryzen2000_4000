...
/**
  ...
  @param[out] HashType          Storage for Hash type value. 0-SHA1, 1-SHA256, 2-SHA384, 3-SHA512, 4-MD5


  @retval 0 - Success, non-zero - Failed to detect algorithm

**/
int Pkcs7_return_digestType (const UINT8* AuthData, size_t AuthDataSize, UINT8* HashType);
/**
