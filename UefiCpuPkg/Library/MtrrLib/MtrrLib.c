...
// AMI_OVERRIDE_START >>> Get original Mtrr value before clear/or calculation. If don't do this, when change 
//                        part of Mtrr, the non-change part will be cleared.
      FixedSettings->Mtrr[MsrIndex] = AsmReadMsr64 (mMtrrLibFixedMtrrTable[MsrIndex].Msr);
// AMI_OVERRIDE_END <<<
