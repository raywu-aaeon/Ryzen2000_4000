...
#else
//
// create a fake SMM superviosr protocol and gSmmSupervisorProtocolGuid.
...
{
  UINT32                                  Version;
  UINT32                                  SmiHandlerSize;
  UINTN                                   ErrorReportJumpBuffer;
  SMM_SV_INSTALL_SMI_HANDLER              InstallSmiHandler;
  UINTN                                   InstallErrorReporter;
  UINTN								      TurnOnSmmIsoAtSmmReadyToLock;
};

#define SMM_SUPERVISOR_GUID \
    {0x7456A908, 0x5BC2, 0x4EBE, 0x8E, 0x7C, 0xF2, 0xCD, 0x38, 0xCE, 0xA9, 0xCA}
EFI_GUID gSmmSupervisorProtocolGuid = SMM_SUPERVISOR_GUID;
// SMM_SYS_CALL is a copy from SmmSupervisorPkg\Include\Library\SysCallLib.h
typedef enum {
  SMM_SC_RDMSR        = 0,
  SMM_SC_WRMSR        = 1,
  SMM_SC_CLI          = 2,
...
//(AMI AMD Porting)>> AMD starts this offset from 0xFd00, since SMRAM save state starts from 0xfe00. Reserve 0x100 for PSD, 0xfe00 - 0x100 = 0xfd00
#define SMM_PSD_OFFSET              0xfd00
...
//(AMI AMD Porting) This flag is not used extern BOOLEAN                mSmmS3Flag;
