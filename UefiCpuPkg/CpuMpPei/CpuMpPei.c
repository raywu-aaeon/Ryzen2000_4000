...
#include "CpuMpPei.h"
//(AMI AMD Porting)>> Family 17h don't have AP at PEI phase, so skip it
...
//(AMI AMD porting)>> Family 17h donesn't have APs to initial at PEI phase.
//                    The APs will be initialized at DXE phase.
  SOC_ID_STRUCT                   SocId;
...
//(AMI AMD porting)<<
  ...
  //
  // (AMI AMD Porting)>> AMD don't have Bist ppi
