...
InitInt13RuntimeImage()
{
    ...
    UsbSmmRt.MiscInfo = 1;
    UsbSmmRt.SmmAttr = 0;
    UsbSmmRt.SmmPort = SW_SMI_IO_ADDRESS;
    UsbSmmRt.SmmData = gUsbData->UsbSwSmi;
...
)
{
    ...
    if (gUsbData->UsbFeature2 & USB_SKIP_UEFI_DRIVER) return EFI_UNSUPPORTED;
