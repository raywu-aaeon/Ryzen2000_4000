...
// Interrupter Moderation Register Bit 15:0  Interrupt Moderation Interval IMODI
//                                     31:16 Interrupt Moderation Counter  IMODC
// Minimum inter-interrupt interval, in 250ns units. The value of 4000 makes 1ms interval.
//
#define XHCI_IMODI 4000
#define XHCI_KEYREPEAT_IMODI_16MS     0x0000FA00 //(16 * 4000)
#define XHCI_KEYREPEAT_IMODC_16MS     0xFA000000 //(16 * 4000)
#define XHCI_KEYREPEAT_IMOD_16MS      XHCI_KEYREPEAT_IMODC_16MS | XHCI_KEYREPEAT_IMODI_16MS

#define XHCI_KEYREPEAT_IMODI_8MS      0x00007D00 //(8 * 4000)
#define XHCI_KEYREPEAT_IMODC_8MS      0x7D000000 //(8 * 4000)
#define XHCI_KEYREPEAT_IMOD_8MS       XHCI_KEYREPEAT_IMODC_8MS | XHCI_KEYREPEAT_IMODI_8MS
...
#define ERST_OFFSET             0x1200
#define CMD_RING_OFFSET         0x2000
#define EVENT_RING_OFFSET       0x2400
...
struct _USB3_HOST_CONTROLLER {
    ...
    UINT8                   ContextSize;
    XHCI_DCBAA              *DcbaaPtr;
    XHCI_DCBAA              *DcbaaPtrMap;
    VOID                    *DcbaaPtrMapping;
    TRB_RING                CmdRing;
    TRB_RING                EvtRing;
    TRB_RING                *XfrRings;
    UINTN                   XfrTrbs;
