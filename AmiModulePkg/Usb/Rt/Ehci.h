...
/**
 ...
 Fields:   Name       Type        Description
      ------------------------------------------------------------
      NextqTDPtr DWORD   Pointer to next qTD
      AltNextqTDPtr  DWORD   Pointer to alternate next qTD
      Token      DWORD   Token double word
      BufferPtr0 DWORD   Buffer pointer page 0
      BufferPtr1 DWORD   Buffer pointer page 1
      BufferPtr2 DWORD   Buffer pointer page 2
      BufferPtr3 DWORD   Buffer pointer page 3
      BufferPtr4 DWORD   Buffer pointer page 4

**/
typedef struct _EHCI_QTD  EHCI_QTD;  
struct _EHCI_QTD {
    UINT32      NextQtdPtr;
    UINT32      AltNextQtdPtr;
    UINT32      Token;
    UINT32      BufferPtr0;
    UINT32      BufferPtr1;
    UINT32      BufferPtr2;
...
/**
 ...
 Fields:   Name       Type        Description
      ------------------------------------------------------------
      LinkPointer    DWORD   Pointer to the next queue head
      EndPntCharac   DWORD   Endpoint characteristics settings
      EndPntCap  DWORD   Endpoint capability settings
      CurqTDPtr  DWORD   Pointer to current Qtd
      NextqTDPtr DWORD   Pointer to next Qtd
      AltNextqTDPtr  DWORD   Pointer to alternate next Qtd
      Token      DWORD   Token double word
      BufferPtr0 DWORD   Buffer pointer page 0
