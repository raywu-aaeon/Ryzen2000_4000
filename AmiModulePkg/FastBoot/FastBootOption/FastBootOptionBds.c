...
///---------------------------------------------------------------------------
 BOOLEAN gTempDeviceFound = FALSE;
 UINT16  gBootDeviceType = 0;
...
SetBootNextBootOption()
{
    ...
    if ( gTempDeviceFound )
    {
        ...
        if ( GetUefiDeviceType(Option->FilePathList) == gBootDeviceType )
        {
