...
/* TPM values */
#define TCM_DEVICE_BASE           0xfed40000
...
#define TPM_ACCESS_ADDR(locality)		((UINTN)TCM_DEVICE_BASE + (UINTN)(locality * TPM_LOCALITY_SIZE) + TPM_REG_ACCESS)
#define TPM_STATUS_ADDR(locality)		((UINTN)TCM_DEVICE_BASE + (UINTN)(locality * TPM_LOCALITY_SIZE) + TPM_REG_STATUS)
#define TPM_BURST_ADDR(locality)		((UINTN)TCM_DEVICE_BASE + (UINTN)(locality * TPM_LOCALITY_SIZE) + TPM_REG_BURST)
#define TPM_VID_L_ADDR(locality)		((UINTN)TCM_DEVICE_BASE + (UINTN)(locality * TPM_LOCALITY_SIZE) + TPM_REG_VID_L)
#define TPM_VID_H_ADDR(locality)		((UINTN)TCM_DEVICE_BASE + (UINTN)(locality * TPM_LOCALITY_SIZE) + TPM_REG_VID_H)
#define TPM_DID_L_ADDR(locality)		((UINTN)TCM_DEVICE_BASE + (UINTN)(locality * TPM_LOCALITY_SIZE) + TPM_REG_DID_L)
#define TPM_DID_H_ADDR(locality)		((UINTN)TCM_DEVICE_BASE + (UINTN)(locality * TPM_LOCALITY_SIZE) + TPM_REG_DID_H)
#define TPM_DATA_ADDR(locality)			((UINTN)TCM_DEVICE_BASE + (UINTN)(locality * TPM_LOCALITY_SIZE) + TPM_REG_DATA)
