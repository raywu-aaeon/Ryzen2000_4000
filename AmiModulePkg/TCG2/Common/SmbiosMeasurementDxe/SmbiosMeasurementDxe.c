...
//
SMBIOS_FILTER_TABLE  mSmbiosFilterType1FilterList[] = {
...
SMBIOS_FILTER_TABLE  mSmbiosFilterType2FilterList[] = {
...
SMBIOS_FILTER_TABLE  mSmbiosFilterType3FilterList[] = {
...
SMBIOS_FILTER_TABLE  mSmbiosFilterType4FilterList[] = {
...
SMBIOS_FILTER_TABLE  mSmbiosFilterType17FilterList[] = {
...
SMBIOS_FILTER_TABLE  mSmbiosFilterType22FilterList[] = {
...
SMBIOS_FILTER_STRUCT  mSmbiosFilterStandardTableFilterList[] = {
  {0x01, mSmbiosFilterType1FilterList,  sizeof(mSmbiosFilterType1FilterList)/sizeof(mSmbiosFilterType1FilterList[0])},
  {0x02, mSmbiosFilterType2FilterList,  sizeof(mSmbiosFilterType2FilterList)/sizeof(mSmbiosFilterType2FilterList[0])},
  {0x03, mSmbiosFilterType3FilterList,  sizeof(mSmbiosFilterType3FilterList)/sizeof(mSmbiosFilterType3FilterList[0])},
  {0x04, mSmbiosFilterType4FilterList,  sizeof(mSmbiosFilterType4FilterList)/sizeof(mSmbiosFilterType4FilterList[0])},
  {0x0B, NULL, 0},
  {0x0F, NULL, 0},
  {0x11, mSmbiosFilterType17FilterList, sizeof(mSmbiosFilterType17FilterList)/sizeof(mSmbiosFilterType17FilterList[0])},
  {0x12, NULL, 0},
  {0x16, mSmbiosFilterType22FilterList, sizeof(mSmbiosFilterType22FilterList)/sizeof(mSmbiosFilterType22FilterList[0])},
  {0x17, mSmbiosFilterType23FilterList, sizeof(mSmbiosFilterType23FilterList)/sizeof(mSmbiosFilterType23FilterList[0])},
  {0x1B, mSmbiosFilterType27FilterList, sizeof(mSmbiosFilterType27FilterList)/sizeof(mSmbiosFilterType27FilterList[0])},
  {0x1F, NULL, 0},
  {0x21, NULL, 0},
  {0x27, mSmbiosFilterType39FilterList, sizeof(mSmbiosFilterType39FilterList)/sizeof(mSmbiosFilterType39FilterList[0])},
};
...
{
  UINTN  Index;
  for (Index = 0; Index < sizeof(mSmbiosFilterStandardTableFilterList)/sizeof(mSmbiosFilterStandardTableFilterList[0]); Index++) {
    if (mSmbiosFilterStandardTableFilterList[Index].Type == Type) {
      return &mSmbiosFilterStandardTableFilterList[Index];
    }
  }
  return NULL;
}
...
)
{
    ...
    if (!EFI_ERROR (Status))
    {
        Status = gBS->AllocatePool(EfiBootServicesData, (sizeof(TrEE_EVENT_HEADER)) + \
                                   sizeof(UINT32) + LogLen, (void **)&Tcg2Event);
    ...
    if (!EFI_ERROR (Status))
    {
       Status = gBS->AllocatePool(EfiBootServicesData, (sizeof(TCG_PCR_EVENT_HDR)) + \
                                                           + LogLen, (void **)&TcgEvent);
...
//    DEBUG(( -1, "[%d]: Tpm20MeasureAndLogData  -%r\n", __LINE__, Status));
    return Status;
}
