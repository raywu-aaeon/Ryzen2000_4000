...
VOID NVOSWrite_MOR_request( )
{
    ...
    Status = SmmVarProtocol->SmmSetVariable(   L"MemoryOverwriteRequestControl",
...
#else
    Status = ptrRuntimeServices->SetVariable ( L"MemoryOverwriteRequestControl", \
             &gEfiMemoryOverwriteControlDataGuid, \
             EFI_VARIABLE_NON_VOLATILE   \
             | EFI_VARIABLE_RUNTIME_ACCESS   \
             | EFI_VARIABLE_BOOTSERVICE_ACCESS, \
...
VOID GetTpmNVSFlags()
{
    ...
    if (NvramControl) NvramControl->ShowBootTimeVariables(TRUE);
     ...
     ptrRuntimeServices->GetVariable( L"TpmServFlags", \
                                   &FlagsStatusguid, \
                                   NULL, \
                                   &Size, \
                                   &NvsMemoryAddress );
