    ...
    IN PEI_TCG_PPI      *tcg )
{
    ...
    SetMem(TcgManifestInfo.Signature,sizeof(TcgManifestInfo.Signature), 0);
    
    //update signature string
    AsciiStrnCpyS((CHAR8 *)TcgManifestInfo.Signature, 
                                sizeof(TcgManifestInfo.Signature),
                                "SP800-155 Event", AsciiStrLen("SP800-155 Event")); 
