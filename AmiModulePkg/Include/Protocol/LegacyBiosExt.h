...
typedef EFI_STATUS (EFIAPI *EFI_AMICSM_GET_16BIT_FUNC_ADDRESS)(UINT16 id, UINT32 *Addr);

typedef UINTN (EFIAPI *EFI_AMICSM_COPY_LEGACY_TABLE)(
    IN VOID *Table,
    IN UINT16 TableSize,
    IN UINT16 Alignment,
...
typedef EFI_STATUS (EFIAPI *EFI_AMICSM_INSTALL_ISA_ROM)(
    IN EFI_LEGACY_BIOS_EXT_PROTOCOL *This,
    IN UINTN    RomAddress
);

typedef EFI_STATUS (EFIAPI *EFI_AMICSM_GET_SHADOWRAM_ADDRESS)(
...
typedef EFI_STATUS (EFIAPI *EFI_CLP_EXECUTE) (
...
typedef EFI_STATUS (EFIAPI *CHECK_UEFI_OPROM_POLICY) (
    IN  AMI_OPROM_POLICY_PROTOCOL *This,
    IN  UINT8                     PciClass
);

typedef VOID (EFIAPI *EXECUTE_OPROM_POLICY)(
...
typedef EFI_STATUS (EFIAPI *EFI_AMICSM16_CONFIGURATION) (
