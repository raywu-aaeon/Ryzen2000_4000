...
//----------------------------Admin Queue--------------------------------------------------------------
    UINT64                      AdminSubmissionUnAligned;      // Not used and do not delete, to maintain backward compatibility
    UINT64                      AdminSubmissionAligned;        // Points to the start of the buffer Aligned
    UINT64                      AdminSubmissionQueueMappedAddr;   // Mapped address for the controller to use
    VOID                        *AdminSubmissionQueueUnMap;
    UINTN                       AdminSubmissionAlignedSize;     // in Pages
    UINT64                      AdminCompletionUnAligned;      // Not used and do not delete, to maintain backward compatibility
    UINT64                      AdminCompletionAligned;        // Points to the start of the buffer Aligned
    UINT64                      AdminCompletionQueueMappedAddr;
    VOID                        *AdminCompletionQueueUnMap;
    UINTN                       AdminCompletionAlignedSize;       // in Pages
    UINT16                      AdminSubmissionQueueSize;         // Max is 4KB, zero based value.
    UINT16                      AdminCompletionQueueSize;         // Max is 4KB, zero based value.

//----------------------------Queue1 for Nvme Cmds------------------------------------------------------
    UINT16                      NVMQueueNumber;
    UINT64                      Queue1SubmissionUnAligned;        // Not used and do not delete, to maintain backward compatibility
    UINTN                       Queue1SubmissionAlignedSize;      // Original size
    UINT64                      Queue1SubmissionAligned;          // Aligned address
    UINT64                      Queue1SubmissionQueueMappedAddr;  // Address for controller to use
    VOID                        *Queue1SubmissionQueueUnMap;      
    UINT64                      Queue1CompletionUnAligned;        // Not used and do not delete, to maintain backward compatibility
    UINTN                       Queue1CompletionAlignedSize;
    UINT64                      Queue1CompletionAligned;
    UINT64                      Queue1CompletionQueueMappedAddr;
    VOID                        *Queue1CompletionQueueUnMap;
    UINT32                      Queue1SubmissionQueueSize;        // Zero based value.
    UINT32                      Queue1CompletionQueueSize;        // Zero based value.
