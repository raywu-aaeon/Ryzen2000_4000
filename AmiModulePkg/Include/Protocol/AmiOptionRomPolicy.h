...
/// Disable device OpROM
#define AMI_OPTION_ROM_POLICY_DISABLE          0
/// Launch UEFI OpROM driver. Do not launch legacy OpROM
#define AMI_OPTION_ROM_POLICY_UEFI             1
/// Launch legacy OpROM. Do not launch UEFI OpROM driver.
#define AMI_OPTION_ROM_POLICY_LEGACY           2
/// OpROM policy is device specific
#define AMI_OPTION_ROM_POLICY_CUSTOM           3
/// Disable device OpROM and block drivers that are part of system firmware from connecting to the device.
#define AMI_OPTION_ROM_POLICY_DISABLE_ALL      4
