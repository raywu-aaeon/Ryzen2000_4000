...
#define TERMINAL_PORTS_VAR_GUID \
{0x279b9a61, 0xf654, 0x49e3, {0xa2, 0x52, 0xa0, 0xb7, 0x6b, 0x7c, 0x38, 0x65}}

#define TERMINAL_SERIAL_VAR_C_NAME         L"TerminalSerialVar"
#define TERMINAL_PORTS_ENABLED_VAR         L"TerminalPortsEnableVar"
