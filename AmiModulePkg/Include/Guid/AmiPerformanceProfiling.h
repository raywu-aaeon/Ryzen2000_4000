...
typedef struct {
  UINTN                             Command;            ///< Command
  EFI_STATUS                        Status;             ///< Return Status of the Communicate call
  UINTN                             NumberOfEntries;    ///< The number of entries allocated by the ProfilingEntry
  UINTN                             EntryNo;            ///< Number of entry to start with
  AMI_PERFORMANCE_PROFILING_ENTRY  *ProfilingEntry;     ///< Pointer to a buffer to fill with the performance profiling entries
} AMI_SMM_PERFORMANCE_PROFILING_COMMUNICATE_EX;
#pragma pack(pop)

#define AMI_SMM_PERFORMANCE_PROFILING_GET_NUMBER_OF_ENTRIES 1
#define AMI_SMM_PERFORMANCE_PROFILING_GET_ENTRIES 2
/**
...
extern EFI_GUID gAmiPerformanceProfilingExGuid;
