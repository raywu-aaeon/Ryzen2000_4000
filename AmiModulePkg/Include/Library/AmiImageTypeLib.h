...
/** @file
  Header file that defines AmiImageTypeLib library class.

  AmiImageTypeLib is a policy library used by SecurityStub driver,
  which calls AmiGetImageType to identify type of the device the image is originated from.
  Image type returned by AmiImageTypeLib is used to apply appropriate image authentication policy.
  The library is used by the SecurityStub driver indirectly,
  via the security handler installed by the SecureBoot module.
  The library may also be used by other modules that require image classification.
**/
