...
#define ROM_FORM_SET_GUID   \
    {0x97cdc6be, 0x7792, 0x4782, { 0xba, 0x6d, 0xe6, 0xe3, 0xbb, 0x56, 0xac, 0xd8 }}
...
#define PCI_GLOBAL_RSZBAR_QID   0x702B
...
typedef struct _PCI_COMMON_SETUP_DATA {
    ...
    UINT8   ResizableBarSupport;       ///[Disable]\ Enable
