...
/**
    Macro defining PCI Config Space access using PCI Express Base
...
/**
 ...
 Fields:        
   ...
   ------------------------------------------------------------------
    ...
    HostAddr      EFI_PHYSICAL_ADDRESS    Buffer Address of the device who initiated DMA transfer.
    DeviceAddr    EFI_PHYSICAL_ADDRESS    Buffer Address of the device who receives DMA transfer.
**/
...
/**
 ...
 Fields:        
   ...
   ------------------------------------------------------------------
    ...
    Supports        UINT64                       Set of Attributes Supported by this PCI Root Bridge.
    Attributes      UINT64                       Set of currently supported Attributes by this PCI Root Bridge.
    ...
    ResSubmited     BOOLEAN                      Flag to indicate that Resources were submitted by the PciBus Driver.
    ResAsquired     BOOLEAN                      Flag to indicate that Resource request was satisfied by the GCD.
...
typedef struct _PCI_ROOT_BRG_DATA {
    ...
    BOOLEAN                             ResAsquired;
    BOOLEAN                             NotPresent;
    // Used in RootBridgeIoCheck() to maintain the bus base and limit for each RB's
    BOOLEAN                             FoundBusBaseLimit;
    UINT64                              BusBase;
    UINT64                              BusLimit;
    CHAR8                               *RbAslName;
