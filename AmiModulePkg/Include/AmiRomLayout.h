...
/// If the attribute is defined, integrity of the area should be verified via a cryptographic hash.
/// The attribute is used during attestation of the ROM content by system firmware(Aptio).
/// It should not be defined for areas attested by agents outside system firmware.
