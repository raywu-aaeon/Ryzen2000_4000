...
typedef union _PCIE_RESIZ_BAR_CAP_REG {
    ...
    struct {
        ...
        UINT8   BarSize1TB      : 1;    //bit 24
        UINT8   BarSize2TB      : 1;    //bit 25
        UINT8   BarSize4TB      : 1;    //bit 26
        UINT8   BarSize8TB      : 1;    //bit 27
        UINT8   BarSize16TB     : 1;    //bit 28
        UINT8   BarSize32TB     : 1;    //bit 29
        UINT8   BarSize64TB     : 1;    //bit 30
        UINT8   BarSize128TB    : 1;    //bit 31
    };
} PCIE_RESIZ_BAR_CAP_REG;

//Resizable BAR Control Register.
typedef union _PCIE_RESIZ_BAR_CNT_REG {
    UINT32  RESIZ_BAR_CNT;
    struct {
        UINT16  BarIndex        : 3;    //bit 0..2
        UINT16  Reserved1       : 2;    //bit 3,4
        UINT16  NumBars         : 3;    //bit 5..7 valid values 1..6 applicable only for first RESIZ_BAR_CNT_REG for all other -Reserved.
        UINT16  BarSize         : 6;    //bit 8..13
        UINT16  Reserved2       : 2;    //bit 14..15
        UINT16  BarSize256TB    : 1;    //bit 16
        UINT16  BarSize512TB    : 1;    //bit 17
        UINT16  BarSize1PB      : 1;    //bit 18
        UINT16  BarSize2PB      : 1;    //bit 19
        UINT16  BarSize4PB      : 1;    //bit 20
        UINT16  BarSize8PB      : 1;    //bit 21
        UINT16  BarSize16PB     : 1;    //bit 22
        UINT16  BarSize32PB     : 1;    //bit 23
        UINT16  BarSize64PB     : 1;    //bit 24
        UINT16  BarSize128PB    : 1;    //bit 25
        UINT16  BarSize256PB    : 1;    //bit 26
        UINT16  BarSize512PB    : 1;    //bit 27
        UINT16  BarSize1EB      : 1;    //bit 28
        UINT16  BarSize2EB      : 1;    //bit 29
        UINT16  BarSize4EB      : 1;    //bit 30
        UINT16  BarSize8EB      : 1;    //bit 31
    };
