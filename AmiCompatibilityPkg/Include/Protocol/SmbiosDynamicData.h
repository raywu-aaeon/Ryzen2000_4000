...
#define SMBIOS_BASEBOARD_DATA               L"BASEBOARD DATA"
#define SMBIOS_CHASSIS_DATA                 L"CHASSIS DATA"
#define SMBIOS_CPU_DATA                     L"CPU DATA"
#define SMBIOS_SLOTS_DATA                   L"SLOTS DATA"
#define SMBIOS_ONBOARD_DEV_DATA             L"ONBOARD DEV DATA"
#define SMBIOS_MEMORY_DATA                  L"MEMORY DATA"
#define SMBIOS_BATTERY_DATA                 L"BATTERY DATA"
#define SMBIOS_ONBOARD_DEV_EXTENDED_DATA    L"ONBOARD DEV EXTENDED DATA"
...
typedef struct {                                        // Type 17
    ...
    UINT32                    ExtSpeed;                 //SMBIOS 3.3+
    UINT32                    ExtConfigMemSpeed;        //SMBIOS 3.3+
#endif 
} AMI_MEMORY_DEVICE;
