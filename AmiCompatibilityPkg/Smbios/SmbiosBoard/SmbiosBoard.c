...
/**
    ...
    saves them in a variable named "SMBIOS_SLOTS_DATA". This variable
    ...
    @return EFI_STATUS \n
            Variable named "SMBIOS_SLOTS_DATA" with system slot information
...
// Return the slot structure information in a variable named "SMBIOS_SLOTS_DATA"
//
*/
...
/**
    ...
    @return EFI_STATUS \n
            Creates variable named "SMBIOS_BASEBOARD_DATA" with Chassis information
...
//----------------------------------------------------------------------------
	...
	StrSize = AsciiStrSize (BoardManufacturerName);
	
    ZeroMem (BaseBoardInfo.BoardManufacturer, StrSize);
	
    AsciiStrCpyS (BaseBoardInfo.BoardManufacturer,
                  StrSize,
    ...
    StrSize = AsciiStrSize (BoardID_Index[gPlatformInfoProtocol->BoardId]);
    
    ZeroMem (BaseBoardInfo.BoardName, StrSize);
    
    AsciiStrCpyS (BaseBoardInfo.BoardName, 
                  StrSize,
                  BoardID_Index[gPlatformInfoProtocol->BoardId]);
...
/**
    ...
    @return EFI_STATUS \n
            Creates variable named "SMBIOS_CHASSIS_DATA" with Chassis information
...
/**
    ...
    saves them in a variable named "SMBIOS_CPU_DATA". This variable
    ...
    @return EFI_STATUS \n
            Variable named "SMBIOS_CPU_DATA" with System CPU information
...
//----------------------------------------------------------------------------
    ...
    Status = pRS->SetVariable(  SMBIOS_CPU_DATA,
                                &gAmiSmbiosDynamicDataGuid,
                                Attributes,
                                sizeof(CPU_DYNAMIC_DATA),
                                &CpuInfo );
...
/**
    ...
    saves them in a variable named "SMBIOS_ONBOARD_DEV_DATA". This variable
    ...
    @return EFI_STATUS \n
            Variable named "SMBIOS_ONBOARD_DEV_DATA" with on-board device information
...
//----------------------------------------------------------------------------
    ...
    Status = pRS->SetVariable(SMBIOS_ONBOARD_DEV_DATA, &gAmiSmbiosDynamicDataGuid,
...
/**
    ...
    and saves them in a variable named "SMBIOS_ONBOARD_DEV_EXTENDED_DATA".
    ...
    @return EFI_STATUS \n
            Variable named "SMBIOS_ONBOARD_DEV_EXTENDED_DATA" with on-board device\n
            information.
...
//----------------------------------------------------------------------------
    ...
    Status = pRS->SetVariable(SMBIOS_ONBOARD_DEV_EXTENDED_DATA, &gAmiSmbiosDynamicDataGuid,
...
/**
    ...
    @return EFI_STATUS \n
            Variable named "SMBIOS_BATTERY_DATA" with Battery information
...
//----------------------------------------------------------------------------
    ...
    Status = pRS->SetVariable(SMBIOS_BATTERY_DATA,
                        &gAmiSmbiosDynamicDataGuid,
                        Attributes,
                        VarSize,
                        &BatteryInfo);
