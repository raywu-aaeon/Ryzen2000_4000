...
#define AMI_SMM_COMMUNICATION_PROPERTY  (AMI_SMM_COMMUNICATION_PROPERTY_X86_REG_SUPPORT | \
                                         AMI_SMM_COMMUNICATION_PROPERTY_NEW_STYLE_INTERFACE_SUPPORT)

#define IS_AMI_SMM_COMMUNICATION_X86_REG_SUPPORTED  ((PcdGet32(AmiPcdSmmCommInterfaceProperties) & \
                                                     AMI_SMM_COMMUNICATION_PROPERTY) == \
                                                     AMI_SMM_COMMUNICATION_PROPERTY)
