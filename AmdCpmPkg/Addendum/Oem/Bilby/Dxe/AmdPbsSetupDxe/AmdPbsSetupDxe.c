  ...
  )
{
  ...
  switch (QuestionId) {
    ...
    if (AmdPbsSetupConfig.XgbePortPhySwitch != 0)
       AmdPbsSetupConfig.XgbePortRJ45Mode = 1;
    else
        AmdPbsSetupConfig.XgbePortSpeedSwitch = 3;
    ...
    case KEY_XGBE_PORT_RJ45_MODE:
        ...
        if (AmdPbsSetupConfig.XgbePortRJ45Mode != 1){
            AmdPbsSetupConfig.PxeBoot = 0;
        }
