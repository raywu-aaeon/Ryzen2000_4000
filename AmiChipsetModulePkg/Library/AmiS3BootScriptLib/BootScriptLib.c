  ...
  )
{
    ...
    CSP_BOOT_SCRIPT_SERVICE_EX(mS3SaveState)->Write (mS3SaveState, EFI_BOOT_SCRIPT_IO_WRITE_OPCODE, Width, Address, Count, Buffer);
...
{ 
    ...
    CSP_BOOT_SCRIPT_SERVICE_EX(mS3SaveState)->Write (mS3SaveState, EFI_BOOT_SCRIPT_IO_READ_WRITE_OPCODE, Width, Address, Data, DataMask);    
  ...
  )
{
    ...
    CSP_BOOT_SCRIPT_SERVICE_EX(mS3SaveState)->Write (mS3SaveState, EFI_BOOT_SCRIPT_MEM_WRITE_OPCODE, Width, Address, Count, Buffer);
  ...
  )
{
    ...
    CSP_BOOT_SCRIPT_SERVICE_EX(mS3SaveState)->Write (mS3SaveState, EFI_BOOT_SCRIPT_MEM_READ_WRITE_OPCODE, Width, Address, Data, DataMask);    
...
{ 
    ...
    CSP_BOOT_SCRIPT_SERVICE_EX(mS3SaveState)->Write (mS3SaveState, EFI_BOOT_SCRIPT_PCI_CONFIG_WRITE_OPCODE, Width, Address, Count, Buffer);    
...
{  
    ...
    CSP_BOOT_SCRIPT_SERVICE_EX(mS3SaveState)->Write (mS3SaveState, EFI_BOOT_SCRIPT_PCI_CONFIG_READ_WRITE_OPCODE, Width, Address, Data, DataMask);
...
{ 
    ...
    CSP_BOOT_SCRIPT_SERVICE_EX(mS3SaveState)->Write (mS3SaveState, EFI_BOOT_SCRIPT_PCI_CONFIG2_WRITE_OPCODE, Width, Segment, Address, Count, Buffer);
...
{    
    ...
    CSP_BOOT_SCRIPT_SERVICE_EX(mS3SaveState)->Write (mS3SaveState, EFI_BOOT_SCRIPT_PCI_CONFIG2_READ_WRITE_OPCODE, Width, Segment, Address, Data, DataMask);
...
{   
    ...
    CSP_BOOT_SCRIPT_SERVICE_EX(mS3SaveState)->Write (mS3SaveState, EFI_BOOT_SCRIPT_SMBUS_EXECUTE_OPCODE, (((SmBusAddress) >> 1)  & 0x7f), (((SmBusAddress) >> 8)  & 0xff), Operation, (BOOLEAN) (((SmBusAddress) & (1 << 22)) != 0), Length, Buffer);
...
{    
    ...
    CSP_BOOT_SCRIPT_SERVICE_EX(mS3SaveState)->Write (mS3SaveState, EFI_BOOT_SCRIPT_STALL_OPCODE, Duration);
...
{  
    ...
    CSP_BOOT_SCRIPT_SERVICE_EX(mS3SaveState)->Write (mS3SaveState, EFI_BOOT_SCRIPT_DISPATCH_OPCODE, EntryPoint);
...
{   
    ...
    CSP_BOOT_SCRIPT_SERVICE_EX(mS3SaveState)->Write (mS3SaveState, EFI_BOOT_SCRIPT_DISPATCH_2_OPCODE, EntryPoint, Context);
...
{   
    ...
    CSP_BOOT_SCRIPT_SERVICE_EX(mS3SaveState)->Write (mS3SaveState, EFI_BOOT_SCRIPT_MEM_POLL_OPCODE, Width, Address, BitValue, BitMask, Delay);
...
{    
    ...
    CSP_BOOT_SCRIPT_SERVICE_EX(mS3SaveState)->Write (mS3SaveState, EFI_BOOT_SCRIPT_INFORMATION_OPCODE, InformationLength, (EFI_PHYSICAL_ADDRESS)Information);
...
{    
    ...
    CSP_BOOT_SCRIPT_SERVICE_EX(mS3SaveState)->Write (mS3SaveState, EFI_BOOT_SCRIPT_IO_POLL_OPCODE, Width, Address, Data, DataMask, Delay);
...
{    
    ...
    CSP_BOOT_SCRIPT_SERVICE_EX(mS3SaveState)->Write (mS3SaveState, EFI_BOOT_SCRIPT_PCI_CONFIG_POLL_OPCODE, Width, Address, Data, DataMask, Delay);
...
{   
    ...
    CSP_BOOT_SCRIPT_SERVICE_EX(mS3SaveState)->Write (mS3SaveState, EFI_BOOT_SCRIPT_PCI_CONFIG2_POLL_OPCODE, Width, Segment, Address, Data, DataMask, Delay);
