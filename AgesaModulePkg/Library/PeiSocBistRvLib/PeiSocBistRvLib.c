 ...
 *----------------------------------------------------------------------------------------
 */
#define FILECODE LIBRARY_PEISOCBISTRVLIB_PEISOCBISTRVLIB_FILECODE
  ...
  )
{
  ...
  NbioSmuServices->SmuRegisterRead (NbioSmuServices, SystemDieCount, 0x5D260, &BistEnFuse);
  BistEn = (BistEnFuse >> 4) & 0x1;

  NbioSmuServices->SmuRegisterRead (NbioSmuServices, SystemDieCount, 0x5D270, &ColdResetMBistEnFuse);
  ...
  )
{
  ...
  NbioSmuServices->SmuRegisterRead (NbioSmuServices, DieNumber, 0x5D250, &RunMBistFuse);
