...
#ifndef _LIBRARY_CCXSMBIOSVHLIB_CCXSMBIOSVHCOMMONLIB_H_
#define _LIBRARY_CCXSMBIOSVHLIB_CCXSMBIOSVHCOMMONLIB_H_
...
#pragma pack (pop)
#endif  // _LIBRARY_CCXSMBIOSVHLIB_CCXSMBIOSVHCOMMONLIB_H_
