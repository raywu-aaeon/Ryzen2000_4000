...
#include  <Library/NbioSmuV11Lib.h>
#include  <Library/CpuLib.h>
#include  <Library/AmdS3SaveLib.h>

#define FILECODE LIBRARY_NBIOSMUV11LIB_NBIOSMUV11LIB_FILECODE
/*----------------------------------------------------------------------------------------
  ...
  )
{
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "NbioSmuServiceRequestV11 Enter\n");

  DataMask = 0xFFFFFFFF;

  if (RequestId > BIOSSMC_Message_Count) {
    IDS_HDT_CONSOLE (GNB_TRACE, "NbioSmuServiceRequestV11 INVALID!!\n");
...
///@todo - implement S3 save for resume
  ...
  IDS_HDT_CONSOLE (GNB_TRACE, "NbioSmuServiceRequestV11 Exit\n");
  ...
  )
{
  ...
  IDS_HDT_CONSOLE (MAIN_FLOW, "NbioSmuFirmwareTestV11 Enter\n");

  NbioSmuServiceCommonInitArgumentsV11 (SmuArg);
  SmuArg[0] = 0xAA55AA55;
  RequestId = BIOSSMC_MSG_TestMessage;

  NbioSmuServiceRequestV11 (NbioGetHostPciAddress (NbioHandle), RequestId, SmuArg, 0);

  IDS_HDT_CONSOLE (MAIN_FLOW, "  Service Test Return %x\n", SmuArg[0]);
  IDS_HDT_CONSOLE (MAIN_FLOW, "NbioSmuFirmwareTestV11 Exit\n");
  ...
  )
{
  ...
  *DxioMBoxArg = DxioMBoxRequest;
  ...
  if ((RetVal & 0x01) == 0) {
    RetVal = NbioSmuServiceRequestV11(
      NbioGetHostPciAddress (NbioHandle),
