...
#ifndef _LIBRARY_CCXSMBIOSZENRVLIB_CCXSMBIOSZENRVCOMMONLIB_H_
#define _LIBRARY_CCXSMBIOSZENRVLIB_CCXSMBIOSZENRVCOMMONLIB_H_
...
#pragma pack (pop)
#endif  // _LIBRARY_CCXSMBIOSZENRVLIB_CCXSMBIOSZENRVCOMMONLIB_H_
