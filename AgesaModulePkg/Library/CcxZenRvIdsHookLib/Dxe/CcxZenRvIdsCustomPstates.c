...
#define FILECODE LIBRARY_CCXZENRVIDSHOOKLIB_DXE_CCXZENRVIDSCUSTOMPSTATES_FILECODE
...
/*---------------------------------------------------------------------------------------*/
/**
 * CcxZenRvIdsDxeCustomPstates - routine to read Custom Pstates information from IDS
 *
 *
  ...
  )
{
  ...
  if (CcxIsBsp (NULL)) {
    IDS_HDT_CONSOLE (CPU_TRACE, "CcxZenRvIdsDxeCustomPstates Options\n");
