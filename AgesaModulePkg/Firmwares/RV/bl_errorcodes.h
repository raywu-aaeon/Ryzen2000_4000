...
typedef enum BL_RETCODE_T
{
    ...
    BL_ERR_BIOS_HEADER_NOT_MATCH            = 0x7A, // BIOS level 1 directory not match expected value.
	...
	BL_ERR_SPI_ROM_WRITABLE_REGIONS         = 0x94, // Failure in extracting writable regions information from spi-rom
