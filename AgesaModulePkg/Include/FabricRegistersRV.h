...
#ifndef _FABRIC_REGISTERS_RV_H_
#define _FABRIC_REGISTERS_RV_H_
#pragma pack (push, 1)

#define  RV_CS0_FABRIC_ID        0
#define  RV_CS1_FABRIC_ID        1
#define  RV_CCM0_FABRIC_ID       2
#define  RV_GCM0_FABRIC_ID       3
#define  RV_GCM1_FABRIC_ID       4
#define  RV_MMHUB0_FABRIC_ID     5
#define  RV_DCE0_FABRIC_ID       6
#define  RV_ATHUB0_FABRIC_ID     7
#define  RV_IOMS0_FABRIC_ID      9
#define  RV_PIE_FABRIC_ID        10

#define  RV_CS0_INSTANCE_ID      0
#define  RV_CS1_INSTANCE_ID      1
#define  RV_CCM0_INSTANCE_ID     2
#define  RV_GCM0_INSTANCE_ID     3
#define  RV_GCM1_INSTANCE_ID     4
#define  RV_MMHUB0_INSTANCE_ID   5
#define  RV_DCE0_INSTANCE_ID     6
#define  RV_ATHUB0_INSTANCE_ID   7
#define  RV_IOMS0_INSTANCE_ID    9
#define  RV_PIE_INSTANCE_ID      10
#define  RV_TCDX0_INSTANCE_ID    11
#define  RV_TCDX1_INSTANCE_ID    12
#define  RV_TCDX2_INSTANCE_ID    13
#define  RV_TCDX3_INSTANCE_ID    14

#define  RV_NUM_CS_BLOCKS        2
#define  RV_NUM_CCM_BLOCKS       1
#define  RV_NUM_GCM_BLOCKS       2
#define  RV_NUM_IOMS0_BLOCKS     1
#define  RV_NUM_PIE_BLOCKS       1
#define  RV_NUM_TCDX_BLOCKS      4
#define  RV_NUM_DF_BLOCKS        15
#define  MAX_SOCKETS_RV          1   ///< Max number of sockets in system
#define  MAX_DIES_PER_SOCKET_RV  1   ///< Max number of dies per socket
...
/// Common 32bits Bit Field Access Register
typedef union {
  ...
  struct {
    ...
    UINT32 Bit7:1;                   ///< Bit 7
    UINT32 Bit9:1;                   ///< Bit 9
    UINT32 Bit10:1;                  ///< Bit 10
    UINT32 Bit11:1;                  ///< Bit 11
    UINT32 Bit12:1;                  ///< Bit 12
    UINT32 Bit13:1;                  ///< Bit 13
    UINT32 Bit14:1;                  ///< Bit 14
    UINT32 Bit15:1;                  ///< Bit 15
    UINT32 Bit16:1;                  ///< Bit 16
    UINT32 Bit17:1;                  ///< Bit 17
    UINT32 Bit18:1;                  ///< Bit 18
    UINT32 Bit19:1;                  ///< Bit 19
    UINT32 Bit20:1;                  ///< Bit 20
    UINT32 Bit21:1;                  ///< Bit 21
    UINT32 Bit22:1;                  ///< Bit 22
    UINT32 Bit23:1;                  ///< Bit 23
    UINT32 Bit24:1;                  ///< Bit 24
    UINT32 Bit25:1;                  ///< Bit 25
    UINT32 Bit26:1;                  ///< Bit 26
    UINT32 Bit27:1;                  ///< Bit 27
    UINT32 Bit28:1;                  ///< Bit 28
    UINT32 Bit29:1;                  ///< Bit 29
    UINT32 Bit30:1;                  ///< Bit 30
    UINT32 Bit31:1;                  ///< Bit 31
  } Field;
  UINT32  Value;
} COMMON_32BITS_REGISTER;
...
/* DRAM Regions */
#define NUMBER_OF_DRAM_REGIONS       0x2
#define NUMBER_OF_CS_DRAM_REGIONS    0x2
...
typedef union {
  ...
  struct {
    ...
    UINT32 :1;                            ///< Reserved
    UINT32 CCMMWDTCntSel:3;               ///< Core coherent master watchdog timer count select
    UINT32 :13;                           ///< Reserved
  } Field;
  UINT32 Value;
...
/* Coherent Slave Configuration A0 Register */
#define CS_CFG_A0_FUNC 0x2
#define CS_CFG_A0_REG 0x040
#define CS_CFG_A0_PCI_ADDR (MAKE_SBDFO (0, 0, 0x18, CS_CFG_A0_FUNC, CS_CFG_A0_REG))

/// Coherent Slave Configuration A0 Register
typedef union {
  /// Bitfields of Coherent Slave Configuration A0 Register
  struct {
    UINT32 :30;                           ///< Reserved
    UINT32 DisAddrCollNcRdVc6:1;          ///< DisAddrCollNcRdVc6
    UINT32 :1;                            ///< Reserved
  } Field;
  UINT32 Value;
} CS_CFG_A0_REGISTER;
...
#define CS_CFG_A1_FUNC 0x2
#define CS_CFG_A1_REG 0x044
#define CS_CFG_A1_PCI_ADDR (MAKE_SBDFO (0, 0, 0x18, CS_CFG_A1_FUNC, CS_CFG_A1_REG))

/// Coherent Slave Configuration A1 Register
typedef union {
  /// Bitfields of Coherent Slave Configuration A1 Register
  struct {
    UINT32 :26;                           ///< Reserved
    UINT32 EnHoldTgtDnForDramWr:1;        ///< EnHoldTgtDnForDramWr
    UINT32 :5;                            ///< Reserved
  } Field;
  UINT32 Value;
} CS_CFG_A1_REGISTER;
...
#define CS_CFG_A2_FUNC 0x2
#define CS_CFG_A2_REG 0x048
#define CS_CFG_A2_PCI_ADDR (MAKE_SBDFO (0, 0, 0x18, CS_CFG_A2_FUNC, CS_CFG_A2_REG))

/// Coherent Slave Configuration A2 Register
typedef union {
  /// Bitfields of Coherent Slave Configuration A2 Register
  struct {
    UINT32 :6;                            ///< Reserved
    UINT32 EnSkipGpuPrbEncNonZeroKey:1;   ///< EnSkipGpuPrbEncNonZeroKey
    UINT32 :8;                            ///< Reserved
    UINT32 DisReqBypEA:1;                 ///< Reserved
    UINT32 :3;                            ///< Reserved
    UINT32 InclSdpCredRlsAllDrained:1;    ///< InclSdpCredRlsAllDrained
    UINT32 :12;                           ///< Reserved
  } Field;
  UINT32 Value;
} CS_CFG_A2_REGISTER;

/* Coherent Slave Mode Control A0 Register */
#define CS_MODE_CTRL_A0_FUNC 0x2
#define CS_MODE_CTRL_A0_REG 0x050
#define CS_MODE_CTRL_A0_PCI_ADDR (MAKE_SBDFO (0, 0, 0x18, CS_MODE_CTRL_A0_FUNC, CS_MODE_CTRL_A0_REG))

/// Coherent Slave Mode Control A0 Register
typedef union {
  /// Bitfields of Coherent Slave Mode Control A0 Register
  struct {
    UINT32 :5;                            ///< Reserved
    UINT32 ForceEAInOrder:1;              ///< ForceEAInOrder
    UINT32 :26;                           ///< Reserved
  } Field;
  UINT32 Value;
} CS_MODE_CTRL_A0_REGISTER;
...
/* GCM and NCM Control Register */
#define GCM_NCM_CTRL_FUNC 0x3
#define GCM_NCM_CTRL_REG 0x20C
#define GCM_NCM_CTRL_PCI_ADDR (MAKE_SBDFO (0, 0, 0x18, GCM_NCM_CTRL_FUNC, GCM_NCM_CTRL_REG))

/// GCM and NCM Control Register
typedef union {
  /// Bitfields of GCM and NCM Control Register
  struct {
    UINT32 MapSdpVc0ToFtiVc5:1;             ///< MapSdpVc0ToFtiVc5
    UINT32 GcmSelfGenPrbRsp:1;              ///< GcmSelfGenPrbRsp
    UINT32 :30;                             ///< Reserved
  } Field;
  UINT32 Value;
} GCM_NCM_CTRL_REGISTER;
...
/* Master Light Load And Lone Potoato Request Priority Threshold Register */
...
/// Master Light Load And Lone Potoato Request Priority Threshold Register
typedef union {
  /// Bitfields of Master Light Load And Lone Potoato Request Priority Threshold Register
  struct {
...
/* DF PC6 Service Control Register */
#define DF_PC6_SERVICE_CTRL_FUNC 0x5
#define DF_PC6_SERVICE_CTRL_REG 0x338
#define DF_PC6_SERVICE_CTRL_PCI_ADDR (MAKE_SBDFO (0, 0, 0x18, DF_PC6_SERVICE_CTRL_FUNC, DF_PC6_SERVICE_CTRL_REG))

/// DF PC6 Service Control Register
typedef union {
  /// Bitfields of DF PC6 Service Control Register
  struct {
    UINT32 :3;                            ///< Reserved
    UINT32 Pc6RampOnFchHint:1;            ///< Pc6RampOnFchHint
    UINT32 :28;                           ///< Reserved
  } Field;
  UINT32 Value;
} DF_PC6_SERVICE_CTRL_REGISTER;

/* Power Management State Machine Timer Control 0 Register */
#define PWR_MGMT_TMR_CTRL0_FUNC 0x5
#define PWR_MGMT_TMR_CTRL0_REG 0x348
#define PWR_MGMT_TMR_CTRL0_PCI_ADDR (MAKE_SBDFO (0, 0, 0x18, PWR_MGMT_TMR_CTRL0_FUNC, PWR_MGMT_TMR_CTRL0_REG))

/// Power Management State Machine Timer Control 0 Register
typedef union {
  /// Bitfields of Power Management State Machine Timer Control 0 Register
  struct {
    UINT32 ClkGaterPropDly:7;           ///< ClkGaterPropDly
    UINT32 :1;                          ///< Reserved
    UINT32 CreditReleaseToDrainDly:7;   ///< CreditReleaseToDrainDly
    UINT32 :1;                          ///< Reserved
    UINT32 ComponentDrainedSampleDly:7; ///< ComponentDrainedSampleDly
    UINT32 :1;                          ///< Reserved
    UINT32 ProbesDrainedSampleDly:7;    ///< ProbesDrainedSampleDly
    UINT32 :1;                          ///< Reserved
  } Field;
  UINT32 Value;
} PWR_MGMT_TMR_CTRL0_REGISTER;

/* Power Management State Machine Timer Control 1 Register */
#define PWR_MGMT_TMR_CTRL1_FUNC 0x5
#define PWR_MGMT_TMR_CTRL1_REG 0x34C
#define PWR_MGMT_TMR_CTRL1_PCI_ADDR (MAKE_SBDFO (0, 0, 0x18, PWR_MGMT_TMR_CTRL1_FUNC, PWR_MGMT_TMR_CTRL1_REG))

/// Power Management State Machine Timer Control 1 Register
typedef union {
  /// Bitfields of Power Management State Machine Timer Control 1 Register
  struct {
    UINT32 :16;                        ///< Reserved
    UINT32 AllDrainedTimeoutDly:5;     ///< AllDrainedTimeoutDly
    UINT32 AllDrainedTimeoutScale:3;   ///< AllDrainedTimeoutScale
    UINT32 :8;                         ///< Reserved
  } Field;
  UINT32 Value;
} PWR_MGMT_TMR_CTRL1_REGISTER;

/* Power Management Hysteresis Control Register */
#define PWR_MGMT_HYST_CTRL_FUNC 0x5
#define PWR_MGMT_HYST_CTRL_REG 0x350
#define PWR_MGMT_HYST_PCI_ADDR (MAKE_SBDFO (0, 0, 0x18, PWR_MGMT_HYST_CTRL_FUNC, PWR_MGMT_HYST_CTRL_REG))

/// Power Management Hysteresis Control Register
typedef union {
  /// Bitfields of Power Management Hysteresis Control Register
  struct {
    UINT32 :24;                        ///< Reserved
    UINT32 DfCstateHyst:8;             ///< DfCstateHyst
  } Field;
  UINT32 Value;
} PWR_MGMT_HYST_CTRL_REGISTER;
...
/* Power Management Configuration 0 Register */
#define PWR_MGMT_CFG0_FUNC 0x5
#define PWR_MGMT_CFG0_REG 0x360
#define PWR_MGMT_CFG0_PCI_ADDR (MAKE_SBDFO (0, 0, 0x18, PWR_MGMT_CFG0_FUNC, PWR_MGMT_CFG0_REG))

/// Power Management Configuration 0 Register
typedef union {
  /// Bitfields of Power Management Configuration 0 Register
  struct {
    UINT32 MmhubEarlyDisconDis:1;      ///< MmhubEarlyDisconDis
    UINT32 :2;                         ///< Reserved
    UINT32 DceLptModeDis:1;
    UINT32 :17;                        ///< Reserved
    UINT32 DowngradeCstateCommonClkGate:1;     ///< VdciBusyPstateChkDis
    UINT32 :10;                        ///< Reserved
  } Field;
  UINT32 Value;
} PWR_MGMT_CFG0_REGISTER;

/* Power Management Configuration 1 Register */
#define PWR_MGMT_CFG1_FUNC 0x5
#define PWR_MGMT_CFG1_REG 0x364
#define PWR_MGMT_CFG1_PCI_ADDR (MAKE_SBDFO (0, 0, 0x18, PWR_MGMT_CFG1_FUNC, PWR_MGMT_CFG1_REG))

/// Power Management Configuration 1 Register
typedef union {
  /// Bitfields of Power Management Configuration 1 Register
  struct {
    UINT32 :1;                         ///< Reserved
    UINT32 VdciBusyPstateChkDis:1;     ///< VdciBusyPstateChkDis
    UINT32 :30;                        ///< Reserved
  } Field;
  UINT32 Value;
} PWR_MGMT_CFG1_REGISTER;
