...
//USB31 PHY internal Registers
#define FCH_SS_USB0_USB31_PHY_INTERNAL       0x16D20000ul
#define FCH_SS_USB0_LANE0_DIG_ANA_RX_ANA_IQ_PHASE_ADJUST         (FCH_SS_USB0_USB31_PHY_INTERNAL + 0x42D0)        //0x42D0
#define FCH_SS_USB0_LANE1_DIG_ANA_RX_ANA_IQ_PHASE_ADJUST         (FCH_SS_USB0_USB31_PHY_INTERNAL + 0x46D0)        //0x46D0
#define FCH_SS_USB0_LANEX_DIG_ANA_RX_ANA_IQ_PHASE_ADJUST         (FCH_SS_USB0_USB31_PHY_INTERNAL + 0x242D0)       //0x242D0
#define FCH_SS_USB0_RAWLANE0_DIG_PCS_XF_RX_EQ_DELTA_IQ_OVRD_IN   (FCH_SS_USB0_USB31_PHY_INTERNAL + 0xC064)        //0xC064
#define FCH_SS_USB0_RAWLANE1_DIG_PCS_XF_RX_EQ_DELTA_IQ_OVRD_IN   (FCH_SS_USB0_USB31_PHY_INTERNAL + 0xC464)        //0xC464
#define FCH_SS_USB0_RAWLANEX_DIG_PCS_XF_RX_EQ_DELTA_IQ_OVRD_IN   (FCH_SS_USB0_USB31_PHY_INTERNAL + 0x28064)       //0x28064
#define FCH_SS_USB0_RAWLANE0_DIG_AON_RX_IQ_PHASE_ADJUST          (FCH_SS_USB0_USB31_PHY_INTERNAL + 0xC14C)        //0xC14C
#define FCH_SS_USB0_RAWLANE1_DIG_AON_RX_IQ_PHASE_ADJUST          (FCH_SS_USB0_USB31_PHY_INTERNAL + 0xC54C)        //0xC54C
#define FCH_SS_USB0_RAWLANEX_DIG_AON_RX_IQ_PHASE_ADJUST          (FCH_SS_USB0_USB31_PHY_INTERNAL + 0x2814C)       //0x2814C
#define FCH_SS_USB0_SUP_DIG_LVL_OVRD_IN                          (FCH_SS_USB0_USB31_PHY_INTERNAL + 0x3C)          //0x3C
#define FCH_SS_USB0_SUPX_DIG_LVL_OVRD_IN                         (FCH_SS_USB0_USB31_PHY_INTERNAL + 0x2003C)       //0x2003C
#define FCH_SS_USB1_USB31_PHY_INTERNAL       0x16F20000ul
#define FCH_SS_USB1_LANE0_DIG_ANA_RX_ANA_IQ_PHASE_ADJUST         (FCH_SS_USB1_USB31_PHY_INTERNAL + 0x42D0)        //0x42D0
#define FCH_SS_USB1_LANE1_DIG_ANA_RX_ANA_IQ_PHASE_ADJUST         (FCH_SS_USB1_USB31_PHY_INTERNAL + 0x46D0)        //0x46D0
#define FCH_SS_USB1_LANEX_DIG_ANA_RX_ANA_IQ_PHASE_ADJUST         (FCH_SS_USB1_USB31_PHY_INTERNAL + 0x242D0)       //0x242D0
#define FCH_SS_USB1_RAWLANE0_DIG_PCS_XF_RX_EQ_DELTA_IQ_OVRD_IN   (FCH_SS_USB1_USB31_PHY_INTERNAL + 0xC064)        //0xC064
#define FCH_SS_USB1_RAWLANE1_DIG_PCS_XF_RX_EQ_DELTA_IQ_OVRD_IN   (FCH_SS_USB1_USB31_PHY_INTERNAL + 0xC464)        //0xC464
#define FCH_SS_USB1_RAWLANEX_DIG_PCS_XF_RX_EQ_DELTA_IQ_OVRD_IN   (FCH_SS_USB1_USB31_PHY_INTERNAL + 0x28064)       //0x28064
#define FCH_SS_USB1_RAWLANE0_DIG_AON_RX_IQ_PHASE_ADJUST          (FCH_SS_USB1_USB31_PHY_INTERNAL + 0xC14C)        //0xC14C
#define FCH_SS_USB1_RAWLANE1_DIG_AON_RX_IQ_PHASE_ADJUST          (FCH_SS_USB1_USB31_PHY_INTERNAL + 0xC54C)        //0xC54C
#define FCH_SS_USB1_RAWLANEX_DIG_AON_RX_IQ_PHASE_ADJUST          (FCH_SS_USB1_USB31_PHY_INTERNAL + 0x2814C)       //0x2814C
#define FCH_SS_USB1_SUP_DIG_LVL_OVRD_IN                          (FCH_SS_USB1_USB31_PHY_INTERNAL + 0x3C)          //0x3C
#define FCH_SS_USB1_SUPX_DIG_LVL_OVRD_IN                         (FCH_SS_USB1_USB31_PHY_INTERNAL + 0x2003C)       //0x2003C
...
#define FCH_SS_SATA_RSMU_COLD_RESETB         FCH_SS_SMN_SATA_RSMU_BASE + 0x04
#define FCH_SS_SATA_RSMU_HARD_RESETB         FCH_SS_SMN_SATA_RSMU_BASE + 0x08
