...
///RPMC Control
///Enable : Enable RMPC function, Disable : Disable RMPC function, Auto : Keep default behavior
typedef enum {
  IDSOPT_CMN_SOC_RPMC_CONTROL_AUTO = 2,///<Auto
  IDSOPT_CMN_SOC_RPMC_CONTROL_ENABLE = 1,///<Enable
  IDSOPT_CMN_SOC_RPMC_CONTROL_DISABLE = 0,///<Disable
} IDSOPT_CMN_SOC_RPMC_CONTROL;
...
///SMBUS SPD Voltage
///Smbus SPD Voltage set by ABL
typedef enum {
  IDSOPT_CMN_SPD_SMBUS_VOLTAGE_33V = 0,///<3.3V
  IDSOPT_CMN_SPD_SMBUS_VOLTAGE_18V = 1,///<1.8V
} IDSOPT_CMN_SPD_SMBUS_VOLTAGE;
...
///-	Not all TDP/System Configurations listed can be applied: Check the Infrastructure Roadmap Document on DevHub (Infrastructure tab). The AUTO configuration will be applied in case an unsupported system configuration (lower or upper out of bound) is selected. The AUTO configuration is the upper/highest Embedded system configuration supported for an Embedded Ryzen part #
typedef enum {
  IDSOPT_CMN_GNB_SMU_SYSTEM_CONFIG_6WSDP15 = 11,///<6W SDP                - 15
  IDSOPT_CMN_GNB_SMU_SYSTEM_CONFIG_6WEMBEDDED16EMBEDDED = 111,///<6W Embedded           - 16 Embedded
  IDSOPT_CMN_GNB_SMU_SYSTEM_CONFIG_8WPORCONFIGURATION13EMBEDDED = 13,///<8W POR Configuration  - 13 Embedded
  IDSOPT_CMN_GNB_SMU_SYSTEM_CONFIG_10WPORCONFIGURATION14EMBEDDED = 12,///<10W POR Configuration -  14 Embedded
  IDSOPT_CMN_GNB_SMU_SYSTEM_CONFIG_12WPORCONFIGURATION10EMBEDDED = 1,///<12W POR Configuration - 10 Embedded
  IDSOPT_CMN_GNB_SMU_SYSTEM_CONFIG_15WPORCONFIGURATION11EMBEDDED = 2,///<15W POR Configuration - 11 Embedded
  IDSOPT_CMN_GNB_SMU_SYSTEM_CONFIG_25WPORCONFIGURATION12EMBEDDED = 3,///<25W POR Configuration - 12 Embedded
...
typedef enum {
  ...
  IDSOPT_CMN_GNB_GFX_UMA_FRAME_BUFFER_SIZE_6G = 6144,///<6G
...
///UMA Above 4G
///If requested UMA frame buffer size can't be fit under 4GB or the system has enough available memory above 4GB, this option may be set to TRUE to allow UMA frame buffer size to be allocated successfully.
typedef enum {
  IDSOPT_DF_CMN_UMA_ABOVE4_G_DISABLED = 0,///<Disabled
  IDSOPT_DF_CMN_UMA_ABOVE4_G_ENABLED = 1,///<Enabled
  IDSOPT_DF_CMN_UMA_ABOVE4_G_AUTO = 0xFF,///<Auto
} IDSOPT_DF_CMN_UMA_ABOVE4_G;
...
typedef enum {
  ...
  IDSOPT_CMN_FCH_UART0_LEGACY_CONFIG_COM10X3F8 = 4,///<COM1 0x3F8
  IDSOPT_CMN_FCH_UART0_LEGACY_CONFIG_COM20X2F8 = 2,///<COM2 0x2F8
  IDSOPT_CMN_FCH_UART0_LEGACY_CONFIG_COM30X3E8 = 3,///<COM3 0x3E8
  IDSOPT_CMN_FCH_UART0_LEGACY_CONFIG_COM40X2E8 = 1,///<COM4 0x2E8
...
typedef enum {
  ...
  IDSOPT_CMN_FCH_UART1_LEGACY_CONFIG_COM10X3F8 = 4,///<COM1 0x3F8
  IDSOPT_CMN_FCH_UART1_LEGACY_CONFIG_COM20X2F8 = 2,///<COM2 0x2F8
  IDSOPT_CMN_FCH_UART1_LEGACY_CONFIG_COM30X3E8 = 3,///<COM3 0x3E8
  IDSOPT_CMN_FCH_UART1_LEGACY_CONFIG_COM40X2E8 = 1,///<COM4 0x2E8
...
typedef enum {
  ...
  IDSOPT_CMN_FCH_UART2_LEGACY_CONFIG_COM10X3F8 = 4,///<COM1 0x3F8
  IDSOPT_CMN_FCH_UART2_LEGACY_CONFIG_COM20X2F8 = 2,///<COM2 0x2F8
  IDSOPT_CMN_FCH_UART2_LEGACY_CONFIG_COM30X3E8 = 3,///<COM3 0x3E8
  IDSOPT_CMN_FCH_UART2_LEGACY_CONFIG_COM40X2E8 = 1,///<COM4 0x2E8
...
typedef enum {
  ...
  IDSOPT_CMN_FCH_UART3_LEGACY_CONFIG_COM10X3F8 = 4,///<COM1 0x3F8
  IDSOPT_CMN_FCH_UART3_LEGACY_CONFIG_COM20X2F8 = 2,///<COM2 0x2F8
  IDSOPT_CMN_FCH_UART3_LEGACY_CONFIG_COM30X3E8 = 3,///<COM3 0x3E8
  IDSOPT_CMN_FCH_UART3_LEGACY_CONFIG_COM40X2E8 = 1,///<COM4 0x2E8
  IDSOPT_CMN_FCH_UART3_LEGACY_CONFIG_AUTO = 0xf,///<AUTO
} IDSOPT_CMN_FCH_UART3_LEGACY_CONFIG;

///Uart Driver Type
///Select UART driver.\nAMD UART Driver (HID AMDI0020)\nAMD Serial Driver (HID AMDI0021)
typedef enum {
  IDSOPT_CMN_FCH_UART_DRIVER_TYPE_AMDUARTDRIVER = 1,///<AMD UART Driver
  IDSOPT_CMN_FCH_UART_DRIVER_TYPE_AMDSERIALDRIVER = 2,///<AMD Serial Driver
} IDSOPT_CMN_FCH_UART_DRIVER_TYPE;
