...
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_RV_GID_0x1704_Type_PsOdtPatDRAMDOWNDdr4
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_RV_GID_0x1704_Type_PsCadBusDRAMDOWNDdr4 
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_RV_GID_0x1704_Type_PsDataBusDRAMDOWNDdr4 
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_RV_GID_0x1704_Type_PsMaxFreqDRAMDOWNDdr4
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_RV_GID_0x1704_Type_PsStretchFreqDRAMDOWNDdr4
