...
typedef struct {
  ...
  UINT32   Reserved[3];               ///< Reserved for alignment purposes
...
#define MAX_GEN_REPLAY_BUFFER_ENTRIES 0x659ul
...
typedef struct {
  ...
  APOB_COMMON_SOCKET_DATA     CommonSocketData[ABL_APOB_MAX_SOCKETS_SUPPORTED];
} APOB_DATA;
