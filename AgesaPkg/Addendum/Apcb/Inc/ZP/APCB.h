...
#define UNSUPPORTED_DDR_FREQUENCY 2101 ///< Highest limit of DDR frequency
...
typedef struct _SPD_MUX_INFO {
  ...
  UINT8  MuxI2CAddress;       ///< I2C Mux Address
...
/// UDIMM&RDIMM RttNom and RttWr
typedef struct {
  _4BYTE_ALIGN UINT32 TblSize;              ///< Dram term
} PSCFG_TABLE_SIZE;
 ...
 *----------------------------------------------------------------------------
 */
#define APCB_HEADER_VERSION     0x00000030  // APCB Version
...
#define APCB_TOKEN_CBS_CMN_CPU_CPB 0x0060
#define APCB_TOKEN_CBS_CMN_GNB_PC_IE_GEN_SPEED 0x0061
#define APCB_TOKEN_CBS_CMN_END 0x0062
...
#define APCB_TOKEN_CBS_DBG_MEM_CONTEXT_RESTORE 0x00C6
#define APCB_TOKEN_CBS_DBG_CPU_GEN_HDT_BRKPT1 0x00C7
#define APCB_TOKEN_CBS_DBG_MEM_PHY_RX_CLK_DLY_OVERRIDE_OP 0x00C8
#define APCB_TOKEN_CBS_DBG_MEM_PHY_RX_CLK_DLY_OVERRIDE_VALUE 0x00C9
#define APCB_TOKEN_CBS_DBG_MEM_PHY_RX_CLK_DLY_OVERRIDE_TURNING_CONTROL 0x00CA
#define APCB_TOKEN_CBS_DBG_MEM_PHY_RX_CLK_DLY_OVERRIDE_INSTANCE_CONTROL 0x00CB
#define APCB_TOKEN_CBS_DBG_MEM_PHY_RX_CLK_DLY_OVERRIDE_UMC_BIT_MASK 0x00CC
#define APCB_TOKEN_CBS_DBG_MEM_PHY_RX_CLK_DLY_OVERRIDE_CS_BIT_MASK 0x00CD
#define APCB_TOKEN_CBS_DBG_MEM_PHY_RX_CLK_DLY_OVERRIDE_BYTE_BIT_MASK 0x00CE
#define APCB_TOKEN_CBS_DBG_MEM_PHY_RX_CLK_DLY_OVERRIDE_NIBBLE_BIT_MASK 0x00CF
#define APCB_TOKEN_CBS_DBG_MEM_PHY_RX_CLK_DLY_OVERRIDE_PSTATE_BIT_MASK 0x00D0
#define APCB_TOKEN_CBS_DBG_MEM_PHY_RX_PB_DLY_OVERRIDE_OP 0x00D1
#define APCB_TOKEN_CBS_DBG_MEM_PHY_RX_PB_DLY_OVERRIDE_VALUE 0x00D2
#define APCB_TOKEN_CBS_DBG_MEM_PHY_RX_PB_DLY_OVERRIDE_TURNING_CONTROL 0x00D3
#define APCB_TOKEN_CBS_DBG_MEM_PHY_RX_PB_DLY_OVERRIDE_INSTANCE_CONTROL 0x00D4
#define APCB_TOKEN_CBS_DBG_MEM_PHY_RX_PB_DLY_OVERRIDE_UMC_BIT_MASK 0x00D5
#define APCB_TOKEN_CBS_DBG_MEM_PHY_RX_PB_DLY_OVERRIDE_CS_BIT_MASK 0x00D6
#define APCB_TOKEN_CBS_DBG_MEM_PHY_RX_PB_DLY_OVERRIDE_BYTE_BIT_MASK 0x00D7
#define APCB_TOKEN_CBS_DBG_MEM_PHY_RX_PB_DLY_OVERRIDE_DQ_BIT_MASK 0x00D8
#define APCB_TOKEN_CBS_DBG_END 0x00D9
...
///
typedef enum {
  ABL_MEM_OVERCLOCK_ERROR_MEM_INIT        = 0,
  MEM_OVERCLOCK_ERROR_MEM_TEST        = 1,
  ABL_MEM_OVERCLOCK_ERROR_MEM_OTHER       = 2,
  ABL_MEM_OVERCLOCK_ERROR_PMU_TRAINING    = 3,
  ABL_MEM_OVERCLOCK_ERROR_RRW_TEST        = 4,
