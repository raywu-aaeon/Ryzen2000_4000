IF NOT DEFINED TOOL_DIR @ECHO OFF
REM ============================================================================
REM ============================================================================
REM ============================================================================
...
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_RV_GID_0x1704_Type_PsOdtPatSODIMMDdr4
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_RV_GID_0x1704_Type_PsCadBusSODIMMDdr4 
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_RV_GID_0x1704_Type_PsDataBusSODIMMDdr4 
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_RV_GID_0x1704_Type_PsMaxFreqSODIMMDdr4
SET APCB_DATA_TYPE_FILE_LIST=%APCB_DATA_TYPE_FILE_LIST% ApcbData_RV_GID_0x1704_Type_PsStretchFreqSODIMMDdr4
